...
const realityItems = [{"pre":"تقارير البنك المركزي — يدوية","text":"التقارير التنظيمية بطيئة وعرضة للأخطاء وفرق الامتثال تحت ضغط متواصل."},{"pre":"تصاعد تعقيد الاحتيال","text":"الأنظمة التقليدية عاجزة عن رصد أنماط الاحتيال المعقدة آنيًا."},{"pre":"اختناقات اعرف عميلك","text":"التحقق اليدوي من المستندات يطيل مدة تأهيل العميل لأسابيع."},{"pre":"تشتت بيانات العملاء","text":"بيانات موزعة بين أنظمة وقنوات متعددة — غياب منظور موحد لبيانات العملاء."},{"pre":"متطلبات المصرفية المفتوحة","text":"معمارية API آمنة مطلوبة. الأنظمة التقليدية لم تُصمم لإتاحة الخدمات عبر واجهات API."},{"pre":"مرونة البنية التحتية","text":"متطلبات استمرارية الأعمال تتطلب توفرًا بنسبة ٩٩.٩٩% مع تعافٍ سيبراني كامل."}];
const priorities = [{"title":"المخاطر والامتثال المدعوم بالذكاء","desc":"كشف الاحتيال الفوري، مراقبة معاملات مكافحة غسل الأموال، وأتمتة الامتثال والتقارير التنظيمية.","icon":"Shield"},{"title":"ذكاء العملاء","desc":"توحيد بيانات Customer 360، تخصيص مدفوع بالذكاء الاصطناعي، والتفاعل التنبؤي.","icon":"Users"},{"title":"المصرفية الرقمية الحديثة","desc":"منصات مصرفية رقمية بالأساس، تحول الخدمات المصرفية عبر الجوال.","icon":"CreditCard"},{"title":"الخدمات المصرفية المفتوحة","desc":"معمارية API، بوابة API آمنة، وامتثال إطار المصرفية المفتوحة.","icon":"GitBranch"},{"title":"إجراءات اعرف عميلك والتأهيل الرقمي للعملاء","desc":"معالجة ذكية للمستندات، تحقق آلي من الهوية — أسرع بثلاث مرات.","icon":"TrendingUp"},{"title":"بنية تحتية مرنة سيبرانيًا","desc":"بنية تحتية متوافقة مع استمرارية الأعمال، Zero Trust، توفر +٩٩.٩٩%.","icon":"Shield"}];
...
const services = [{"svc":"الاستشارات والتخطيط","app":"الجاهزية التنظيمية لمتطلبات البنك المركزي، استراتيجية الاحتيال، معمارية المصرفية المفتوحة"},{"svc":"التنفيذ والتسليم","app":"نشر ذكاء الاحتيال، بناء Customer 360، منصة المصرفية المفتوحة"},{"svc":"العمليات المدارة","app":"مركز عمليات أمنية مصرفي على مدار الساعة، عمليات بنية تحتية بضمان مستوى الخدمة"}];
