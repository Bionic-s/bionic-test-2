...
const priorities = [{"title":"المخاطر والامتثال المدعوم بالذكاء","desc":"كشف الاحتيال الفوري، مراقبة معاملات مكافحة غسل الأموال، وأتمتة تنظيم البنك المركزي.","icon":"Shield"},{"title":"ذكاء العملاء","desc":"توحيد بيانات Customer 360، تخصيص مدفوع بالذكاء الاصطناعي، والتفاعل التنبؤي.","icon":"Users"},{"title":"المصرفية الرقمية الحديثة","desc":"منصات مصرفية رقمية أولاً، تحول الخدمات المصرفية عبر الجوال.","icon":"CreditCard"},{"title":"الخدمات المصرفية المفتوحة","desc":"معمارية API، بوابة API آمنة، وامتثال إطار المصرفية المفتوحة.","icon":"GitBranch"},{"title":"إجراءات اعرف عميلك والانضمام الرقمي للعملاء","desc":"معالجة ذكية للمستندات، تحقق آلي من الهوية — أسرع بثلاث مرات.","icon":"TrendingUp"},{"title":"بنية تحتية مرنة سيبرانيًا","desc":"بنية تحتية متوافقة مع استمرارية الأعمال، Zero Trust، توفر +٩٩.٩٩%.","icon":"Shield"}];
