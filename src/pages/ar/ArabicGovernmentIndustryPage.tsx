      ...
      <Helmet>
        ...
        <motion.section className="mb-0" {...fadeIn} transition={{ duration: 0.5 }}>
          ...
          <p className="text-text-muted text-lg max-w-[720px] leading-relaxed" style={{ fontFamily: "'Tajawal', sans-serif" }}>
            انطلاقاً من تمكين الذكاء الاصطناعي الوطني وصولاً إلى السحابة السيادية المتوافقة مع الهيئة الوطنية للأمن السيبراني، ومن أنسجة البيانات بين الوزارات إلى تحقيق مستهدفات رؤية ٢٠٣٠ — نمكّن الجهات الحكومية السعودية من تسريع التحول الوطني.
          </p>
        </motion.section>
            </div>
          </div>
