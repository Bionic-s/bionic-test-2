...
const capabilities = [{"cap":"الذكاء الاصطناعي المؤسسي والأتمتة","app":"ذكاء المستندات لاعتماد، ذكاء خدمة المواطن، حوكمة نماذج الذكاء السيادية"},{"cap":"البيانات والتحليلات والذكاء","app":"نسيج البيانات بين الوزارات، لوحات مؤشرات الأداء الوطنية، منصات البيانات المفتوحة"},{"cap":"التكامل والعمليات الذكية","app":"تكامل أنظمة الحكومة عبر API، تنسيق سير العمل عبر الجهات، تحديث ESB"},{"cap":"الأمن السيبراني والمرونة السيبرانية","app":"مركز عمليات أمنية وطني، امتثال NCA ECC، Zero Trust للحكومة"},{"cap":"البنية التحتية السيادية والسحابة الهجينة","app":"مراكز بيانات متوافقة مع NCA، سحابة سيادية، بنية ذكاء معزولة تمامًا عن الشبكات"},{"cap":"عمليات التقنية","app":"مركز عمليات شبكة وطني ٢٤×٧، عمليات منصات سيادية، إدارة أحمال العمل المصنفة"}];
