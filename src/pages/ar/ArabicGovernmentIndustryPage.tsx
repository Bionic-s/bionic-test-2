...
const priorities = [{"title":"تمكين الذكاء الاصطناعي الوطني","desc":"بناء قدرة المملكة في الذكاء الاصطناعي — منصات وطنية، حوكمة النماذج، تنمية الكوادر.","icon":"Cpu"},{"title":"منصات البيانات والذكاء السيادية","desc":"بنية تحتية للذكاء متوافقة مع NCA، بحيرات بيانات سيادية، قدرة حوسبة وطنية.","icon":"Shield"},{"title":"الذكاء عبر الوزارات","desc":"نسيج بيانات بين الجهات لكسر عقود من العزل.","icon":"GitBranch"},{"title":"تنفيذ برامج رؤية ٢٠٣٠","desc":"إدارة برامج مدعومة بالذكاء الاصطناعي، تتبع مؤشرات الأداء، حوكمة التحول.","icon":"TrendingUp"},{"title":"العمليات السيبرانية الوطنية","desc":"مركز عمليات أمنية وطني على مدار الساعة، حماية البنية التحتية الحيوية.","icon":"Shield"},{"title":"تحول خدمات المواطنين","desc":"بوابات مواطنين مدعومة بالذكاء الاصطناعي، معالجة ذكية للمستندات.","icon":"BarChart3"}];
const capabilities = [{"cap":"الذكاء الاصطناعي المؤسسي والأتمتة","app":"ذكاء المستندات لمنصة اعتماد، ذكاء خدمة المواطن، حوكمة نماذج الذكاء السيادية"},{"cap":"البيانات والتحليلات والذكاء","app":"نسيج البيانات بين الوزارات، لوحات مؤشرات الأداء الوطنية، منصات البيانات المفتوحة"},{"cap":"التكامل والعمليات الذكية","app":"تكامل أنظمة الحكومة عبر API، تنسيق سير العمل عبر الجهات، تحديث ESB"},{"cap":"الأمن السيبراني والمرونة السيبرانية","app":"مركز عمليات أمنية وطني، امتثال NCA ECC، Zero Trust للحكومة"},{"cap":"البنية التحتية السيادية والسحابة الهجينة","app":"مراكز بيانات متوافقة مع NCA، سحابة سيادية، بنية ذكاء معزولة تمامًا عن الشبكات"},{"cap":"عمليات التقنية","app":"مركز عمليات شبكة وطني على مدار الساعة، عمليات منصات سيادية، إدارة أحمال العمل المصنفة"}];
...
const services = [{"svc":"الاستشارات والتخطيط","app":"استشارات الامتثال لـ NCA/NDMO، الجاهزية للذكاء الاصطناعي للحكومة، تصميم المعمارية السيادية"},{"svc":"التنفيذ والتسليم","app":"نشر السحابة السيادية، بناء نسيج البيانات الوطني، تسليم منصة خدمات المواطنين"},{"svc":"العمليات المدارة","app":"مركز عمليات أمنية كخدمة على مدار الساعة، عمليات منصات سيادية، مركز عمليات شبكة وطني"}];
      ...
      <Helmet>
        ...
        <motion.section className="mb-0" {...fadeIn} transition={{ duration: 0.5 }}>
          ...
          <p className="text-text-muted text-lg max-w-[720px] leading-relaxed" style={{ fontFamily: "'Tajawal', sans-serif" }}>
            انطلاقاً من تمكين الذكاء الاصطناعي الوطني وصولاً إلى السحابة السيادية المتوافقة مع الهيئة الوطنية للأمن السيبراني، ومن نسيج البيانات بين الوزارات إلى تحقيق مستهدفات رؤية ٢٠٣٠ — نمكّن الجهات الحكومية السعودية من تسريع التحول الوطني.
          </p>
        </motion.section>
            </div>
          </div>
