...
const blueprints = [{"title":"تكامل OT/IT والعمليات الآمنة","industry":"نفط وغاز","slug":"ot-it-integration-secure-ops"},{"title":"Customer 360 والمشاركة الذكية","industry":"بنوك","slug":"customer-360-intelligent-engagement"},{"title":"تحول القوى العاملة الوكيلة","industry":"مؤسسات","slug":"agentic-workforce-transformation"}];
...
const realityItems = [{"iconName":"Plug","text":"أنظمة لا تستطيع تبادل البيانات في الوقت الفعلي."},{"iconName":"Activity","text":"تسليم يدوي يبطئ العمليات ويدخل الأخطاء."},{"iconName":"Network","text":"تكاملات نقطة إلى نقطة تخلق تعقيدًا غير قابل للإدارة."},{"iconName":"Zap","text":"لا رؤية تشغيلية فورية عبر وظائف الأعمال."},{"iconName":"Workflow","text":"شركاء وموردون منفصلون عن الأنظمة المؤسسية الأساسية."},{"iconName":"RefreshCw","text":"التكامل يُعامل كعمل مشروع وليس قدرة مؤسسية مستمرة."}];
const coreCaps = [{"title":"استراتيجية ومعمارية API","desc":"تصميم معماريات اتصال بقيادة API تحول الأنظمة إلى قدرات أعمال قابلة لإعادة الاستخدام.","iconName":"GitBranch","outcomes":["استراتيجية API مرتبطة بقدرات الأعمال","طبقة API قابلة لإعادة الاستخدام","حوكمة API مع إدارة دورة الحياة","معمارية أمان شاملة"]},{"title":"الاتصال المؤسسي","desc":"ربط أي نظام — سحابة، محلي، قديم، أو شريك — من خلال نسيج تكامل موحد.","iconName":"Network","outcomes":["نسيج تكامل موحد عبر جميع الأنظمة","موصلات مسبقة البناء تسرع الوصول للتكامل","اتصال فوري ودفعي"]},{"title":"تنسيق سير العمل الذكي","desc":"تصميم وأتمتة سير عمل شامل عبر الإدارات والأنظمة.","iconName":"Workflow","outcomes":["سير عمل عبر الإدارات بدون تسليم يدوي","وقت دورة منخفض عبر المشتريات والعمليات","معالجة استثناءات مع توجيه ذكي"]},{"title":"العمليات الوكيلة","desc":"نشر وكلاء ذكاء اصطناعي يكشفون الأحداث ويطلقون سير العمل وينسقون الإجراءات.","iconName":"Zap","outcomes":["عمليات مدفوعة بالأحداث تستجيب فوريًا","توجيه بالذكاء في سير العمل","وقت حل منخفض من خلال الاستجابة الآلية"]},{"title":"تكامل الشركاء والمنظومة","desc":"دمج الموردين والموزعين والمنصات الحكومية في العمليات المؤسسية.","iconName":"Network","outcomes":["تأهيل شريك آمن مع وصول API محكوم","تكامل منصات اعتماد والمشتريات الحكومية","اتصال مورد وموزع للرؤية الشاملة"]},{"title":"عمليات التكامل والتطور المستمر","desc":"تشغيل ومراقبة وتحسين طبقة التكامل باستمرار.","iconName":"RefreshCw","outcomes":["مراقبة تكامل 24×7 مع تنبيه استباقي","تحسين أداء عبر حركة API","تطور تكامل مستمر"]}];
const whyItems = [{"title":"تكامل متعدد المزودين. بدون احتكار.","desc":"نصمم عبر MuleSoft و IBM و Google Cloud و Informatica."},{"title":"عمليات وكيلة. أبعد من الأتمتة.","desc":"نبني عمليات تستشعر وتستجيب وتتكيف من خلال تنسيق مدفوع بالذكاء."},{"title":"تكامل مؤسسي سعودي. مثبت.","desc":"خبرة في ربط المنصات الحكومية والأنظمة المصرفية وتخطيط الموارد."},{"title":"شريك واحد. مساءلة كاملة.","desc":"من استراتيجية API إلى عمليات التكامل 24×7."}];
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <section className="relative overflow-hidden">
          ...
          <p className="text-lg md:text-xl text-text-muted font-light max-w-3xl mx-auto leading-relaxed">
            نربط التطبيقات ونؤتمت سير العمل وننسق العمليات الذكية عبر المؤسسة — مصممة للسرعة والنطاق والبيئة التنظيمية السعودية.
          </p>
          </motion.div>
        </section>
