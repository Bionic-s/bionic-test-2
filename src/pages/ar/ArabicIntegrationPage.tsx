...
const coreCaps = [{"title":"استراتيجية ومعمارية API","desc":"تصميم معماريات ربط عبر واجهات API تحول الأنظمة إلى قدرات أعمال قابلة لإعادة الاستخدام.","iconName":"GitBranch","outcomes":["استراتيجية API مرتبطة بقدرات الأعمال","طبقة API قابلة لإعادة الاستخدام","حوكمة API مع إدارة دورة الحياة","معمارية أمان شاملة"]},{"title":"الاتصال المؤسسي","desc":"ربط أي نظام — سحابة، محلي، قديم، أو شريك — من خلال نسيج تكامل موحد.","iconName":"Network","outcomes":["نسيج تكامل موحد عبر جميع الأنظمة","موصلات جاهزة تسرّع الوصول إلى التكامل","اتصال فوري ودفعي"]},{"title":"تنسيق سير العمل الذكي","desc":"تصميم وأتمتة سير عمل شامل عبر الإدارات والأنظمة.","iconName":"Workflow","outcomes":["سير عمل عبر الإدارات بدون تسليم يدوي","تسريع وقت الدورة عبر المشتريات والعمليات","معالجة استثناءات مع توجيه ذكي"]},{"title":"العمليات القائمة على وكلاء الذكاء الاصطناعي","desc":"نشر وكلاء ذكاء اصطناعي يكشفون الأحداث ويطلقون سير العمل وينسقون الإجراءات.","iconName":"Zap","outcomes":["عمليات مدفوعة بالأحداث تستجيب فوريًا","توجيه بالذكاء في سير العمل","تسريع وقت الحل من خلال الاستجابة الآلية"]},{"title":"تكامل الشركاء والمنظومة","desc":"دمج الموردين والموزعين والمنصات الحكومية في العمليات المؤسسية.","iconName":"Network","outcomes":["تأهيل شريك آمن مع وصول API محكوم","تكامل منصات اعتماد والمشتريات الحكومية","اتصال مورد وموزع للرؤية الشاملة"]},{"title":"عمليات التكامل والتطور المستمر","desc":"تشغيل ومراقبة وتحسين طبقة التكامل باستمرار.","iconName":"RefreshCw","outcomes":["مراقبة تكامل على مدار الساعة مع تنبيه استباقي","تحسين أداء حركة API","تطور مستمر للتكامل"]}];
...
const insightItems = [{"tag":"المعمارية","title":"الربط عبر واجهات API في الممارسة","desc":"لماذا تتفوق المعماريات المدفوعة بالأحداث و API على التكامل التقليدي."},{"tag":"السعودية","title":"تكامل المنصات الحكومية","desc":"كيف يمكن للمؤسسات السعودية تصميم التكامل مع اعتماد والخدمات الحكومية."},{"tag":"العمليات","title":"صعود العمليات القائمة على وكلاء الذكاء الاصطناعي","desc":"كيف يحول وكلاء الذكاء العمليات المؤسسية إلى سير عمل ذكي فوري."}];
        ...
        <motion.section ref={ref2} {...fadeIn} animate={inView2 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { href: '/ar/services/operations', title: 'العمليات المدارة', desc: 'عمليات المنصات على مدار الساعة · مركز العمليات الأمنية كخدمة · مستويات خدمة متدرّجة' },
            ].map((s, i) => (
        ...
        >
          <div className="rounded-2xl p-10 md:p-14 text-center"
            ...
            <p className="text-text-muted text-base mb-8 max-w-xl mx-auto leading-relaxed">
              لنناقش كيف يمكن للربط عبر واجهات API والعمليات القائمة على وكلاء الذكاء الاصطناعي تحويل سرعة المؤسسة — مع أمن وحوكمة مدمجة.
            </p>
