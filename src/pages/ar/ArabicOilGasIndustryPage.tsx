...
const outcomes = [{"metric":"30–50%","label":"أقل أحداث توقف"},{"metric":"+٢٠%","label":"تحسين استخدام الأصول"},{"metric":"99.9%","label":"توفر شبكة OT"},{"metric":"فوري","label":"كشف تهديدات OT"},{"metric":"شامل","label":"مراقبة آلية للانبعاثات"}];
...
export default function ArabicOilGasIndustryPage() {
  ...
  return (
    <div
      ...
      <Helmet>
        <title>النفط والغاز | بيونك سوليوشنز — مُمكّن التحول المؤسسي بالذكاء الاصطناعي</title>
        <meta name="description" content="التحول بالذكاء الاصطناعي لقطاع النفط والغاز — الصيانة التنبؤية، الامتثال للصحة والسلامة والبيئة، واستخبارات بيانات التقنية التشغيلية." />
      </Helmet>
