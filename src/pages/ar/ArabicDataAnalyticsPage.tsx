...
const realityItems = [{"iconName":"Database","text":"بيانات متناثرة عبر الصوامع — لا مرجع موحد للبيانات."},{"iconName":"Server","text":"الأنظمة القديمة لا تستطيع دعم أحمال الذكاء الاصطناعي الآنية."},{"iconName":"Eye","text":"القادة يتخذون قرارات بناءً على الحدس وليس الذكاء."},{"iconName":"GitBranch","text":"بيانات رئيسية غير متسقة عبر الأنظمة المؤسسية."},{"iconName":"LineChart","text":"تحليلات تنتج تقارير — وليس قرارات."},{"iconName":"Shield","text":"مخاطر الامتثال للبيانات تحت PDPL والتشريعات القطاعية."}];

const coreCaps = [{"title":"استراتيجية البيانات وتحديث المنصات","desc":"تقييم نضج البيانات، تصميم المعمارية المستهدفة، والترحيل من مستودعات قديمة إلى منصات جاهزة للذكاء الاصطناعي.","iconName":"Database","outcomes":["خط أساس لنضج البيانات مع خارطة طريق تحديث","معمارية مستهدفة مصممة للذكاء وأحمال العمل الآنية","استراتيجية ترحيل مع تخفيف المخاطر","اختيار منصة مدفوع بالملاءمة وليس الحوافز"]},{"title":"هندسة بيانات جاهزة للذكاء","desc":"بناء مسارات البيانات ومستودعات الخصائص وأسس البيانات التي تغذي الذكاء المؤسسي.","iconName":"GitBranch","outcomes":["خطوط بيانات آلية من المصدر إلى استهلاك الذكاء","مستودعات خصائص موحدة لنماذج تعلم الآلة","إدخال فوري ودفعي يدعم الاحتياجات التشغيلية والتحليلية","أطر جودة بيانات مدمجة في كل مرحلة"]},{"title":"الذكاء التنفيذي ولوحات المعلومات","desc":"تصميم أطر مؤشرات الأداء ولوحات فورية تحول البيانات الخام إلى ذكاء القرارات.","iconName":"BarChart3","outcomes":["لوحات تنفيذية مرتبطة بالأهداف الاستراتيجية","مراقبة مؤشرات أداء فورية مع تعمق للتفاصيل","تحليلات خدمة ذاتية تمكّن فرق الأعمال","ذكاء القرارات يحل محل الحدس"]},{"title":"إدارة البيانات الرئيسية والحوكمة","desc":"إنشاء مرجع موحد للبيانات عبر المؤسسة.","iconName":"Server","outcomes":["بيانات رئيسية موحدة عبر جميع الأنظمة","مراقبة آلية لجودة البيانات","تتبع كامل للبيانات للتدقيق والامتثال","جهد تسوية منخفض عبر المالية وسلسلة الإمداد"]},{"title":"التحليلات المتقدمة والذكاء التنبؤي","desc":"تجاوز التقارير الوصفية إلى التحليلات التنبؤية والتوجيهية.","iconName":"LineChart","outcomes":["نماذج تنبؤية للطلب والمخاطر والتنبؤ التشغيلي","نمذجة سيناريوهات للقرارات الاستراتيجية","توصيات توجيهية مدمجة في سير العمل","تحسين مستمر للنماذج"]},{"title":"سيادة البيانات والامتثال","desc":"تصميم معماريات بيانات تلبي متطلبات إقامة البيانات السعودية.","iconName":"Shield","outcomes":["معمارية إقامة بيانات متوافقة مع المتطلبات السيادية","امتثال PDPL مدمج في جمع وتخزين ومعالجة البيانات","حوكمة نقل البيانات عبر الحدود","منصات بيانات جاهزة للتدقيق"]}];
...
const insightItems = [{"tag":"استراتيجية البيانات","title":"أساس البيانات الجاهز للذكاء الاصطناعي","desc":"لماذا المؤسسات التي تستثمر في تحديث منصة البيانات قبل نشر الذكاء تحقق وقت وصول أسرع للقيمة."},{"tag":"السعودية","title":"PDPL وضرورة سيادة البيانات","desc":"كيف يمكن للمؤسسات السعودية بناء معماريات بيانات متوافقة تلبي متطلبات الإقامة."},{"tag":"القيادة","title":"من لوحات المعلومات إلى ذكاء القرارات","desc":"التحول من التقارير الوصفية إلى ذكاء القرارات المدعوم بالذكاء الاصطناعي."}];
