...
export default function ArabicDataAnalyticsPage() {
  ...
  return (
    <div
      ...
      <Helmet>
        <title>البيانات والتحليلات والاستخبارات | بيونك سوليوشنز — مُمكّن التحول المؤسسي بالذكاء الاصطناعي</title>
        <meta name="description" content="البيانات والتحليلات والاستخبارات — منصات بيانات جاهزة للذكاء الاصطناعي، لوحات معلومات تنفيذية، إدارة البيانات الرئيسية، والتحليلات المتقدمة." />
      </Helmet>
