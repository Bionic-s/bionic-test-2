...
const partners = [{"name":"Salesforce","role":"إدارة علاقات العملاء والمشاركة","tech":"Sales Cloud · Service Cloud · Marketing Cloud · Commerce Cloud · Experience Cloud"},{"name":"Tableau","role":"ذكاء العملاء والتحليلات","tech":"CRM Analytics · Embedded BI · Customer 360 dashboards"},{"name":"Informatica","role":"جودة بيانات العملاء وإدارة البيانات الرئيسية","tech":"Customer 360 MDM · Data Quality · Data Catalog"},{"name":"IBM","role":"ذكاء العملاء والتحليلات","tech":"watsonx.ai · watsonx Assistant · Customer analytics · Journey AI"},{"name":"MuleSoft","role":"التكامل والاتصال عبر API","tech":"Anypoint Platform · API Manager · Flex Gateway · RPA · Composer"}];
const blueprints = [{"title":"Customer 360 والمشاركة الذكية","industry":"بنوك","slug":"customer-360-intelligent-engagement"},{"title":"تجربة المريض الذكية","industry":"رعاية صحية","slug":"intelligent-patient-experience"},{"title":"تحول القوى العاملة الوكيلة","industry":"مؤسسات","slug":"agentic-workforce-transformation"}];
...
const realityItems = [{"iconName":"Users","text":"رؤية عميل متجزئة عبر الإدارات والقنوات."},{"iconName":"Layout","text":"أنظمة إدارة علاقات عملاء قديمة تلتف حولها الفرق."},{"iconName":"MessageSquare","text":"مراكز اتصال مثقلة بالحجم وليست ممكنة بالذكاء."},{"iconName":"Globe","text":"التسويق والمبيعات والخدمة تعمل في صوامع منفصلة."},{"iconName":"ShoppingCart","text":"قنوات تجارة رقمية تفشل في التحويل أو الاحتفاظ."},{"iconName":"Briefcase","text":"موظفون يتنقلون في أنظمة داخلية قديمة يوميًا."}];
const coreCaps = [{"title":"استراتيجية وتحول منصة إدارة علاقات العملاء","desc":"من إدارة علاقات عملاء قديمة إلى منصات عملاء ذكية مدمجة بالذكاء الاصطناعي.","iconName":"Users","outcomes":["خارطة طريق مرتبطة بنماذج تشغيل المبيعات والخدمة","رؤية عميل موحدة عبر جميع القنوات","سير عمل مدمج بالذكاء يسرع دورات الصفقات","استراتيجية تبني تضمن احتضان المنصة"]},{"title":"تصميم وتقديم تجربة العملاء","desc":"تحديث مراكز الاتصال بالذكاء المحادثة والخدمة الذاتية الذكية.","iconName":"MessageSquare","outcomes":["حجم مركز اتصال منخفض من خلال الخدمة الذاتية","حل أسرع للحالات بمساعدة الذكاء","تجربة متسقة عبر الصوت والدردشة والخدمة الذاتية"]},{"title":"أتمتة التسويق ورحلات العملاء","desc":"تصميم وأتمتة رحلات عملاء مخصصة متعددة القنوات.","iconName":"Globe","outcomes":["مشاركة مخصصة عبر البريد والجوال ووسائل التواصل","تنسيق رحلة آلي مدفوع بسلوك العميل","ذكاء أداء الحملة مع إسناد مغلق الحلقة"]},{"title":"التجارة والقنوات الرقمية","desc":"بناء تجارب تجارة B2B و B2C تحول — كتالوج موحد وتوصيات ذكية.","iconName":"ShoppingCart","outcomes":["منصة تجارة موحدة عبر B2B و B2C","اكتشاف منتجات بالذكاء وتوصيات ذكية","دفع مبسط يقلل التخلي ويزيد التحويل"]},{"title":"تجربة الموظف ومكان العمل الرقمي","desc":"تصميم بوابات خدمة داخلية ومنصات معرفة تجعل العمل أسهل.","iconName":"Briefcase","outcomes":["بوابة موظف خدمة ذاتية تقلل حجم حالات الموارد البشرية","إدارة معرفة تمكن حلولاً أسرع","وصول للجوال أولاً للفرق الميدانية"]},{"title":"عمليات وتطور تطبيقات الأعمال","desc":"تطور مستمر للمنصة — إصدارات مدارة ودعم مستخدم وتحليلات تبني.","iconName":"Heart","outcomes":["تحسين مستمر للمنصة مع دورات إصدار مدارة","تحليلات تبني تحدد فرص التدريب","دعم استباقي يقلل وقت تعطل المستخدم"]}];
const whyItems = [{"title":"متعدد المورّدين. بدون احتكار.","desc":"نصمم عبر Salesforce و Tableau و Informatica و IBM — نختار بناءً على الملاءمة."},{"title":"تسليم يركز على التبني.","desc":"نشر التقنية هو البداية فقط. كل مشاركة تشمل استراتيجية تبني وتمكين مستخدم."},{"title":"سياق العميل السعودي.","desc":"إدارة بيانات عملاء متوافقة مع PDPL وتصميم تجربة بالعربية أولاً."},{"title":"شريك واحد. مساءلة كاملة.","desc":"من استراتيجية إدارة العلاقات إلى العمليات المدارة — علاقة مسؤولة واحدة."}];
const industryItems = [{"industry":"القطاع الحكومي","apps":"بوابات خدمة المواطن، تحديث مركز اتصال 937، إدارة علاقات عملاء حكومية."},{"industry":"القطاع المصرفي","apps":"إدارة علاقات مصرفية، منصات إدارة الثروات، التأهيل الرقمي."},{"industry":"الرعاية الصحية","apps":"منصات مشاركة المريض، إدارة المواعيد، Patient 360."},{"industry":"النفط والغاز","apps":"بوابات عملاء B2B، إدارة الخدمة الميدانية، إدارة علاقات المتعاقدين."},{"industry":"التجزئة","apps":"تجارة موحدة، ولاء وتخصيص، أتمتة خدمة العملاء."},{"industry":"الاتصالات","apps":"إدارة المشتركين، رعاية متعددة القنوات، منع التوقف."}];
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <section className="relative overflow-hidden">
          ...
          <p className="text-lg md:text-xl text-text-muted font-light max-w-3xl mx-auto leading-relaxed">
            نصمم وننشر ونطور تطبيقات الأعمال التي تدعم علاقات العملاء وتجربة الموظف والتجارة الرقمية — مبنية لواقع السوق السعودي.
          </p>
          </motion.div>
        </section>
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {realityItems.map((item: any, i: number) => (
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl px-5 py-4 transition-all duration-300 flex items-center gap-3 hover:border-[#F97316]30" style={{ flexDirection: 'row-reverse' }}>
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: '#F9731615', color: '#F97316' }}>{iconMap[item.iconName]}</div>
        ...
        <motion.section ref={ref2} {...fadeIn} animate={inView2 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <div className="space-y-4">
            {capsWithIcons.map((cap: any, i: number) => (
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl p-6 transition-all duration-300 hover:border-[#F97316]1A">
                <div className="flex flex-col md:flex-row md:items-start gap-5" style={{ flexDirection: 'row-reverse' }}>
                  <div className="flex-shrink-0 w-11 h-11 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: '#F9731612', color: '#F97316' }}>{cap.icon}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {cap.outcomes.map((o: string, j: number) => (
                        <div key={j} className="flex items-start gap-2 flex-row-reverse">
                          <CheckCircle className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" style={{ color: '#F97316' }} />
        ...
        <motion.section ref={ref2} {...fadeIn} animate={inView2 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { href: '/ar/services/operations', title: 'العمليات المدارة', desc: 'عمليات المنصات 24×7 · مركز العمليات الأمنية كخدمة · 3 مستويات' },
            ].map((s, i) => (
              <Link key={i} to={s.href} className="group bg-bg-secondary border border-white/5 rounded-xl p-6 hover:border-[#F97316]/25 transition-all duration-300 text-right">
                <h3 className="font-semibold mb-1 group-hover:text-[#F97316] transition-colors">{s.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {whyItems.map((item: any, i: number) => (
                <div key={i} className="flex gap-3 flex-row-reverse">
                  <div className="w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0" style={{ backgroundColor: '#F97316' }} />
            ...
            {insightItems.map((item: any, i: number) => (
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl p-6 transition-all duration-300">
                <span className="text-xs font-semibold px-3 py-1 rounded-full mb-4 inline-block"
                  style={{ backgroundColor: '#F9731612', color: '#F97316' }}>{item.tag}</span>
                ...
                <span className="inline-flex items-center gap-1.5 text-xs font-medium" style={{ color: '#F9731699' }}>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {blueprints.map((bp: any, i: number) => (
              <Link key={i} to={`/ar/blueprints/${bpSlugs[i]}`} className="group bg-bg-secondary border border-white/5 rounded-xl p-5 hover:border-[#F97316]/25 transition-all duration-300 text-right">
        ...
        >
          <div className="rounded-2xl p-10 md:p-14 text-center"
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-3">
              ...
              <span style={{ color: '#F97316' }}>ميزة تنافسية</span>؟
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/ar/contact" className="inline-flex items-center gap-2 px-7 py-3.5 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg"
                style={{ backgroundColor: '#F97316', boxShadow: '0 8px 24px #F9731620' }}>
