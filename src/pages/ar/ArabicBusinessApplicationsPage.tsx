...
const whyItems = [{"title":"متعدد المزودين. بدون احتكار.","desc":"نصمم عبر Salesforce و Tableau و Informatica و IBM — نختار بناءً على الملاءمة."},{"title":"تسليم يركز على التبني.","desc":"نشر التقنية هو البداية فقط. كل مشاركة تشمل استراتيجية تبني وتمكين مستخدم."},{"title":"سياق العميل السعودي.","desc":"إدارة بيانات عملاء متوافقة مع PDPL وتصميم تجربة بالعربية أولاً."},{"title":"شريك واحد. مساءلة كاملة.","desc":"من استراتيجية إدارة العلاقات إلى العمليات المدارة — علاقة مسؤولة واحدة."}];
