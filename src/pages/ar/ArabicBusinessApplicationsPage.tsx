...
const blueprints = [{"title":"Customer ٣٦٠ والمشاركة الذكية","industry":"بنوك","slug":"customer-360-intelligent-engagement"},{"title":"تجربة المريض الذكية","industry":"رعاية صحية","slug":"intelligent-patient-experience"},{"title":"تحول فرق العمل المعززة بالذكاء الاصطناعي","industry":"مؤسسات","slug":"agentic-workforce-transformation"}];
...
const industryItems = [{"industry":"القطاع الحكومي","apps":"بوابات خدمة المواطن، تحديث مركز اتصال ٩٣٧، إدارة علاقات عملاء حكومية."},{"industry":"القطاع المصرفي","apps":"إدارة علاقات مصرفية، منصات إدارة الثروات، التأهيل الرقمي."},{"industry":"الرعاية الصحية","apps":"منصات مشاركة المريض، إدارة المواعيد، Patient 360."},{"industry":"النفط والغاز","apps":"بوابات عملاء B2B، إدارة الخدمة الميدانية، إدارة علاقات المتعاقدين."},{"industry":"التجزئة","apps":"تجارة موحدة، ولاء وتخصيص، أتمتة خدمة العملاء."},{"industry":"الاتصالات","apps":"إدارة المشتركين، رعاية متعددة القنوات، منع التوقف."}];
