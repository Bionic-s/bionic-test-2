...
const ACCENT = '#00BFFF';
const HERO_BG = `${import.meta.env.BASE_URL}images/optimized/professional-services-ai-hero.webp`;
    ...
    <div
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-6">معظم تطبيقات الأعمال تُطبَّق — ولا تُتبنّى.</h2>
