    ...
    <div className="min-h-screen bg-bg-primary pt-32 pb-24" dir="rtl">
      <div className="container mx-auto px-4 lg:px-12 max-w-4xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-4 text-text-primary">ماذا تتوقع</h2>
          <p className="text-text-muted leading-relaxed">مناقشة مركزة حول أولويات التحول لديكم. تقييم أولي للجاهزية. تحديد الفرص ذات القيمة العالية. خارطة طريق مبدئية للخطوات التالية.</p>
        </section>
