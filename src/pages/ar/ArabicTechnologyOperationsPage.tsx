...
const capabilities = [
  ...
  { title: 'عمليات منصات متعددة المورّدين', desc: 'نموذج تشغيلي واحد عبر IBM و Dell و Red Hat والسحابة الأصلية.', iconName: 'Cpu', outcomes: ['نموذج تشغيلي واحد', 'سلسلة مساءلة واحدة', 'رؤية موحدة للصحة', 'دليل تشغيل واحد'] },
          ...
          <div className="rounded-2xl p-10 md:p-12" style={{ background: 'linear-gradient(135deg, #D9770608, var(--bg-secondary), var(--bg-secondary))', border: '1px solid #D977061A' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                { title: 'شريك واحد. مساءلة كاملة.', desc: 'من هندسة المنصات إلى SRE إلى عمليات 24×7 — علاقة واحدة.' },
              ].map((item, i) => (
