      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              { pre: 'فجوة هندسة المنصات', text: 'المطورون ينتظرون أسابيع للبنية التحتية — لا منصة مطورين داخلية، لا خدمة ذاتية، لا مسارات تطوير موصى بها' },
        ...
        <motion.section ref={ref2} {...fadeIn} animate={inView2 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { icon: <GitBranch className="w-6 h-6" />, title: 'هندسة المنصات ومنصة المطور الداخلية', desc: 'منصات مطورين داخلية بمسارات تطوير موصى بها. تزويد البنية التحتية في دقائق — لا أسابيع — عبر بوابات خدمة ذاتية، لا تذاكر.' },
              { icon: <Gauge className="w-6 h-6" />, title: 'هندسة موثوقية الأنظمة (SRE)', desc: 'ميزانيات الأخطاء، عمليات مدفوعة بمستوى الخدمة، مراجعات لاحقة للحوادث دون توجيه لوم. الموثوقية كتخصص هندسي — لا قائمة انتظار دعم.' },
              ...
              { icon: <Cpu className="w-6 h-6" />, title: 'عمليات منصات متعددة المورّدين', desc: 'نموذج تشغيل واحد عبر IBM و Dell و Red Hat والسحابة الأصلية. دليل تشغيل واحد، جهة مساءلة واحدة، رؤية واحدة للصحة.' },
        ...
        <motion.section ref={ref3} {...fadeIn} animate={inView3 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { title: 'ندير ما نُصمّمه', desc: 'لا فجوة تسليم بين التصميم والتشغيل. فريق واحد، جهة مساءلة واحدة — قرارات المعمارية تُتخذ مع الواقع التشغيلي مدمجًا فيها.' },
              { title: 'متعدد المورّدين، نموذج تشغيل واحد', desc: 'Dell و IBM و Red Hat والسحابة الأصلية — مراقبة موحَّدة، دليل تشغيل واحد، رؤية واحدة للصحة. لا أنظمة متفرقة تشغيلية خاصة بكل مورّد.' },
        ...
        <motion.section ref={ref5} {...fadeIn} animate={inView5 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { title: 'الاتصالات', desc: 'هندسة منصات تراعي حالة الشبكة — عمليات بنية تحتية متكاملة مع قياس الشبكة لضمان الخدمة من البداية إلى النهاية.' },
