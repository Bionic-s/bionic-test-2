        ...
        >
          ...
          <div className="bg-bg-secondary border border-white/5 rounded-2xl p-8 md:p-12 mb-8">
            <div className="space-y-6">
              {[
                { step: 'بيانات أفضل', leads: 'قرارات أفضل', desc: 'بيانات موحدة ومحكومة ومهيأة للذكاء الاصطناعي — كل مشاركة تُحسّن جودة البيانات عبر المؤسسة. البيانات النظيفة تغذي القرارات السليمة.' },
