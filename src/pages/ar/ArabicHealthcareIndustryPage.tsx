...
const services = [{"svc":"الاستشارات والتخطيط","app":"استراتيجية الصحة الرقمية، خارطة طريق الذكاء السريري، امتثال المعلومات الصحية"},{"svc":"التنفيذ والتسليم","app":"نشر الذكاء السريري، تسليم منصة المريض، بناء منصة البيانات الصحية"},{"svc":"العمليات المدارة","app":"عمليات منصات سريرية 24×7، عمليات أمن المعلومات الصحية"}];
