...
export default function ArabicConsultingAdvisoryPage() {
  ...
  return (
    <div
      ...
      <Helmet>
        <title>الاستشارات والتوجيه | بيونك سوليوشنز — مُمكّن التحول المؤسسي بالذكاء الاصطناعي</title>
        <meta name="description" content="تقييم الجاهزية للذكاء الاصطناعي، تصميم المعمارية، اختيار الموردين، وخارطة طريق التحول." />
      </Helmet>
      {/* ═══ HERO ═══ */}
