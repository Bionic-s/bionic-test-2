        ...
        >
          <div className="container mx-auto px-4 lg:px-12 max-w-6xl">
            ...
            <p className="text-text-muted text-lg max-w-[720px] mx-auto leading-relaxed">
              نمكن المؤسسات السعودية من الإجابة على الأسئلة الأصعب أولاً: ما الأولويات؟ أين تكمن القيمة؟ وكيف يمكن تحقيقها؟ — انطلاقًا من جاهزية الذكاء الاصطناعي إلى تصميم نموذج التشغيل، ومن معمارية الامتثال إلى خارطة طريق متعددة السنوات. نحول الطموحات الاستراتيجية إلى برامج تنفيذية واضحة وقابلة للقياس.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl pb-24">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            تبدأ أسباب تعثر العديد من برامج التحول قبل التنفيذ، عند غياب الرؤية والاستراتيجية الواضحة.
          </h2>
