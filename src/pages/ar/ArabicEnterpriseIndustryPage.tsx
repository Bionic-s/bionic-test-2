...
const services = [{"svc":"الاستشارات والتخطيط","app":"الجاهزية للذكاء، تصميم نموذج التشغيل، استراتيجية Zero Trust"},{"svc":"التنفيذ والتسليم","app":"نشر الذكاء الوكيلي، تحول إدارة العلاقات، تطبيق Zero Trust"},{"svc":"العمليات المدارة","app":"عمليات منصات 24×7، SOC كخدمة، حوكمة FinOps"}];
const svcPaths: string[] = ["/ar/services/advisory","/ar/services/implementation","/ar/services/operations"];
const blueprints = [{"title":"تحول القوى العاملة الوكيلة","label":"مؤسسات"},{"title":"Zero Trust المؤسسي","label":"مؤسسات"},{"title":"Customer 360 والمشاركة الذكية","label":"مؤسسات"}];
const bpSlugs: string[] = ["agentic-workforce-transformation","enterprise-zero-trust","customer-360-intelligent-engagement"];
const partners = [{"name":"Salesforce","role":"إدارة علاقات العملاء والقوى العاملة الوكيلة","tech":"Sales Cloud · Service Cloud · Marketing Cloud · Agentforce"},{"name":"IBM","role":"الذكاء المؤسسي والأمن","tech":"watsonx · QRadar SOC · Instana AIOps · FlashSystem"},{"name":"MuleSoft","role":"التكامل المؤسسي وواجهات API","tech":"Anypoint Platform · API Manager · Flex Gateway"},{"name":"Informatica","role":"إدارة البيانات الرئيسية المؤسسية","tech":"MDM مؤسسي · جودة البيانات · كتالوج البيانات"},{"name":"Dell Technologies","role":"البنية التحتية المؤسسية","tech":"PowerEdge · PowerStore · VxRail · APEX"},{"name":"Intel","role":"الحوسبة المؤسسية وتسريع الذكاء","tech":"Xeon Scalable · Gaudi 3 AI · vPro Security"},{"name":"Google","role":"تحليلات مؤسسية ومنصة ذكاء","tech":"Vertex AI · BigQuery · Looker · Gemini"},{"name":"Tableau","role":"ذكاء أعمال تنفيذي","tech":"Tableau Cloud · تحليلات مضمنة · لوحات تنفيذية"},{"name":"Platform9","role":"منصة متعددة السحابة","tech":"Managed Kubernetes · OpenStack · KubeVirt"},{"name":"Red Hat","role":"هندسة المنصات المؤسسية","tech":"OpenShift · Ansible Automation · RHEL"}];
const outcomes = [{"metric":"30–50%","label":"انخفاض ساعات المهام اليدوية"},{"metric":"مسرّع","label":"إيقاع النشر للإنتاج"},{"metric":"50–80%","label":"تحسين دقة القرار"},{"metric":"مرحلي","label":"نشر Zero Trust"},{"metric":"40–60%","label":"تحويل تذاكر تقنية المعلومات"},{"metric":"قابل للقياس","label":"عائد استثمار BI وCRM"}];
