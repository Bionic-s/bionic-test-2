...
const services = [{"svc":"الاستشارات والتخطيط","app":"الجاهزية للذكاء، تصميم نموذج التشغيل، استراتيجية Zero Trust"},{"svc":"التنفيذ والتسليم","app":"نشر وكلاء الذكاء الاصطناعي، تحول إدارة العلاقات، تطبيق Zero Trust"},{"svc":"العمليات المدارة","app":"عمليات منصات 24×7، SOC كخدمة، حوكمة FinOps"}];
