...
const services = [{"svc":"الاستشارات والتخطيط","app":"الجاهزية للذكاء، تصميم نموذج التشغيل، استراتيجية Zero Trust"},{"svc":"التنفيذ والتسليم","app":"نشر وكلاء الذكاء الاصطناعي، تحول إدارة العلاقات، تطبيق Zero Trust"},{"svc":"العمليات المدارة","app":"عمليات منصات ٢٤×٧، SOC كخدمة، حوكمة FinOps"}];
const svcPaths: string[] = ["/ar/services/advisory","/ar/services/implementation","/ar/services/operations"];
const blueprints = [{"title":"تحول فرق العمل المعززة بالذكاء الاصطناعي","label":"مؤسسات"},{"title":"Zero Trust المؤسسي","label":"مؤسسات"},{"title":"Customer ٣٦٠ والمشاركة الذكية","label":"مؤسسات"}];
