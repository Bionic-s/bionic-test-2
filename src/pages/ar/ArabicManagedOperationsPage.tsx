...
const valueDrivers = [
  { title: 'AIOps', desc: 'قياس موحد عبر كامل ممتلكاتكم التقنية. Instana + Turbonomic + IBM Concert. تحليل آلي للسبب الجذري. برامج AIOps تقلل متوسط وقت الاكتشاف بنسبة تصل إلى 60٪ من خلال الربط الآلي للإشارات.', icon: Activity },
...
const tiers = [
  {
    ...
    ideal: 'للمؤسسات التي تبدأ رحلة العمليات المدارة',
    items: [
      'مراقبة البنية التحتية 24×7 — صحة الخوادم والتخزين والشبكات',
      ...
      'إدارة الحوادث — تنبيه ← تذكرة ← تصعيد، SLA إقرار خلال 15 دقيقة',
...
const capabilityCoverage = [
  ...
  { cap: 'البيانات والتحليلات والذكاء', app: 'عمليات منصة البيانات، مراقبة خطوط الأنابيب، اتفاقيات مستوى خدمة جودة البيانات، توفر ذكاء الأعمال' },
  ...
  { cap: 'الأمن السيبراني والمرونة السيبرانية', app: 'SOC 24×7، إدارة SIEM، صيد التهديدات، الاستجابة للحوادث، عمليات المخزن الاحتياطي' },
        ...
        >
          <div className="container mx-auto px-4 lg:px-12 max-w-6xl">
            <div className="inline-flex items-center px-4 py-2 rounded-full border border-[#D97706]/25 bg-[#D97706]/5 mb-10">
              <span className="text-tiny text-[#D97706] font-semibold tracking-widest uppercase">العمليات المدارة</span>
            </div>
            ...
            <p className="text-text-muted text-lg max-w-[720px] mx-auto leading-relaxed">
              نشغّل منصاتكم المؤسسية بتمكين التحول المستمر كمهمة أساسية. لا نكتفي بإبقاء الأنوار مضاءة — نحن نحسّن ونصمم ونطور منصاتكم باستمرار، مطبقين AIOps و SRE و FinOps وهندسة المنصات لضمان أن تحولكم يحقق قيمة مركبة، وليس عوائد متناقصة.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl pb-24">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            تشغيل المنصات المعقدة أصعب من بنائها — وندرة الكفاءات تزيد الأمر سوءًا.
          </h2>
          <p className="text-text-muted mb-8 max-w-[720px]">
            مهندسو SRE ومهندسو المنصات ومحللو الأمن هم أصعب الأدوار في التوظيف في المملكة العربية السعودية. التغطية التشغيلية تنخفض في الليالي وعطلات نهاية الأسبوع والأعياد — تحديدًا عندما تكون في أمس الحاجة إليها. تشتت الأدوات بدون تكامل يخلق نقاطًا عمياء تشغيلية. التكاليف تنمو بنسبة 30٪+ سنويًا بدون حوكمة. نصلح هذا — بالهندسة أولاً.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              { pre: 'ندرة الكفاءات', text: 'مهندسو SRE ومهندسو المنصات ومحللو الأمن — أصعب الأدوار في التوظيف في المملكة. منصاتكم تحتاجهم 24×7.' },
              ...
              { pre: 'تشتت الأدوات', text: 'أكثر من 10 أدوات مراقبة عبر المورّدين — صفر ترابط، لا رؤية موحدة للصحة، إرهاق التنبيهات يثقل كاهل الفرق.' },
              { pre: 'عمليات تفاعلية', text: 'الفرق تطفئ الحرائق بدلاً من منعها. لا قدرة تنبؤية. متوسط وقت الإصلاح يُقاس بالساعات، وليس بالدقائق.' },
              { pre: 'فراغ رؤية التكاليف', text: 'تكاليف السحابة والبنية التحتية والتراخيص تنمو بنسبة 30٪+ سنويًا — غير متتبعة، غير محكومة، غير ميزانية.' },
              { pre: 'عبء إدارة المورّدين', text: 'إدارة اتفاقيات مستوى الخدمة عبر أكثر من 5 مورّدي تقنية تستهلك أفضل مهندسيك — الذين يجب أن يبنوا، لا أن يديروا.' },
            ].map((item, i) => (
        ...
        <motion.section ref={ref5} {...fadeIn} animate={inView5 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { title: 'تحول مستمر، وليس حالة ثابتة', desc: 'كل ربع سنة نحسّن شيئًا قابلًا للقياس — أهداف مستوى الخدمة، التكاليف، سرعة النشر، تجربة المطورين. العمليات كقيمة مركبة، وليس تكلفة ثابتة.' },
              { title: 'نشغّل ما نصممه', desc: 'لا فجوة تسليم. الفريق الذي صمم منصتكم يطورها باستمرار. قرارات المعمارية تُتخذ مع الواقع التشغيلي مدمجًا من اليوم الأول.' },
              { title: 'مدفوع بالذكاء الاصطناعي، بقيادة هندسية', desc: 'Instana + Turbonomic + AIOps يتنبؤون بالمشكلات قبل أن تصبح حوادث. SRE + هندسة المنصات يمنعونها. الأتمتة هي الاستجابة الأولى — وليس تذكرة.' },
              { title: '3 مستويات، شريك واحد، نضج مركب', desc: 'توسّع من المراقبة الأساسية إلى SRE النخبوي بدون تغيير المزود. النضج التشغيلي يتراكم — كل مستوى يبني على السابق.' },
            ].map((item, i) => (
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl p-5 hover:border-[#D97706]/25 transition-all duration-300">
        ...
        >
          <div className="bg-bg-secondary border border-white/5 rounded-2xl p-8 md:p-12 text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-4">
              هل أنت مستعد لتشغيل تحولكم — بشكل مستمر؟
            </h2>
