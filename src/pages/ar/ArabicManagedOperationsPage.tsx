...
const tiers = [
  ...
  },
  {
    ...
    items: [
      ...
      'هندسة موثوقية الأنظمة — ميزانيات الأخطاء، هندسة أهداف مستوى الخدمة، هندسة الفوضى',
...
const capabilityCoverage = [
  ...
  { cap: 'الأمن السيبراني والمرونة السيبرانية', app: 'SOC على مدار الساعة، إدارة SIEM، صيد التهديدات، الاستجابة للحوادث، عمليات المخزن الاحتياطي' },
...
export default function ArabicManagedOperationsPage() {
  ...
  return (
    <div
      ...
      <Helmet>
        <title>العمليات المدارة | بيونك سوليوشنز — مُمكّن التحول المؤسسي بالذكاء الاصطناعي</title>
        <meta name="description" content="مراقبة على مدار الساعة، عمليات الذكاء الاصطناعي، والتحسين المستمر — نبقى معك بعد التشغيل." />
      </Helmet>
      {/* ═══ HERO ═══ */}
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl pb-24">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              { pre: 'ندرة الكفاءات', text: 'مهندسو SRE ومهندسو المنصات ومحللو الأمن — أصعب الأدوار في التوظيف في المملكة. منصاتكم تحتاجهم على مدار الساعة.' },
