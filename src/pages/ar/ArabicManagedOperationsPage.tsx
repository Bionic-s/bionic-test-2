        ...
        >
          <div className="container mx-auto px-4 lg:px-12 max-w-6xl">
            ...
            <p className="text-text-muted text-lg max-w-[720px] mx-auto leading-relaxed">
              نشغّل منصاتكم المؤسسية وتمكين التحول المستمر هو مهمتنا الأساسية. لا نكتفي بإبقاء الأنظمة عاملة — نحن نحسّن ونصمم ونطور منصاتكم باستمرار، مطبقين AIOps و SRE و FinOps وهندسة المنصات لضمان أن يحقق تحولكم قيمة مركبة، لا عوائد متناقصة.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl pb-24">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <p className="text-text-muted mb-8 max-w-[720px]">
            مهندسو SRE ومهندسو المنصات ومحللو الأمن هم أصعب الأدوار في التوظيف في المملكة العربية السعودية. التغطية التشغيلية تنخفض في الليالي وعطلات نهاية الأسبوع والأعياد — تحديدًا عندما تكون في أمس الحاجة إليها. تشتت الأدوات دون تكامل يخلق نقاطًا عمياء تشغيلية. التكاليف تنمو بنسبة تتجاوز 30٪ سنويًا دون حوكمة. نعالج هذا — بالهندسة أولاً.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              { pre: 'فراغ رؤية التكاليف', text: 'تكاليف السحابة والبنية التحتية والتراخيص تنمو بنسبة تتجاوز 30٪ سنويًا — غير متتبعة، غير محكومة، غير ميزانية.' },
              { pre: 'عبء إدارة المورّدين', text: 'إدارة اتفاقيات مستوى الخدمة عبر أكثر من 5 مورّدي تقنية تستهلك أفضل مهندسيك — الذين ينبغي أن يبنوا، لا أن يديروا.' },
            ].map((item, i) => (
