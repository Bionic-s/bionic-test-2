...
const whyItems = [{"title":"متعدد المزودين. بدون احتكار.","desc":"نصمم عبر Salesforce و Google Cloud و IBM و Intel — نختار المنصة المناسبة لكل قدرة بناءً على الملاءمة."},{"title":"الإنتاج أولاً. ليس التجارب.","desc":"كل مشاركة تقاس بالأنظمة العاملة في الإنتاج — مع أسس MLOps والحوكمة المطلوبة للتشغيل المستدام."},{"title":"السياق السعودي. مصمم من البداية.","desc":"متطلبات SDAIA و NCA و PDPL مدمجة في معماريتنا من اليوم الأول."},{"title":"شريك واحد. مساءلة كاملة.","desc":"من تقييم الجاهزية إلى هندسة المنصات إلى العمليات المدارة — علاقة مسؤولة واحدة."}];
