...
const realityItems = [{"iconName":"Users","text":"فرق عالية القيمة مدفونة في عمل يدوي متكرر."},{"iconName":"FileText","text":"بيانات حرجة محتجزة في مستندات غير مهيكلة."},{"iconName":"GitBranch","text":"تجارب ذكاء اصطناعي منفصلة — لا مسار للتوسع المؤسسي."},{"iconName":"Shield","text":"ذكاء اصطناعي منشور بدون حوكمة أو تدقيق أو مواءمة تنظيمية."},{"iconName":"Cpu","text":"نماذج أولية لا تصل إلى الإنتاج أبدًا."},{"iconName":"Layers","text":"عائد استثمار مفترض غير مقاس. لا مسار لتوسيع الاستثمار."}];

const coreCaps = [{"title":"استراتيجية وتحول الذكاء الاصطناعي","desc":"تقييم الجاهزية، تحديد أولويات حالات الاستخدام، وخارطة طريق تنفيذ لمدة 12 شهرًا — مرتبطة باستراتيجية الأعمال.","iconName":"Layers","outcomes":["خارطة طريق ذكاء اصطناعي مؤسسي مرتبطة بأهداف الأعمال","محفظة حالات استخدام مرتبة حسب التأثير والجدوى","حالة استثمار بمؤشرات أداء قابلة للقياس","أساس حوكمة للمواءمة التنظيمية السعودية"]},{"title":"القوى العاملة الوكيلة","desc":"وكلاء ذكاء اصطناعي يعملون جنبًا إلى جنب مع الفرق البشرية — مع حوكمة human-in-the-loop.","iconName":"Users","outcomes":["جهد يدوي منخفض عبر سير العمل التشغيلي","اتخاذ قرارات متسارع بمساعدة الذكاء الاصطناعي","قدرة تشغيلية قابلة للتوسع بدون نمو متناسب","تحسين مستمر من خلال تعلم الوكيل والتغذية الراجعة"]},{"title":"الأتمتة الذكية","desc":"أتمتة عمليات معقدة عبر الإدارات بذكاء اصطناعي يفهم السياق — تتجاوز RPA الأساسي إلى عمليات ذكية.","iconName":"Cpu","outcomes":["وقت معالجة منخفض في سير العمل عالي الحجم","دقة محسنة في العمليات كثيفة القرار","خفض تكاليف قابل للقياس في العمليات اليدوية","رؤية على مستوى المؤسسة عبر ذكاء العمليات المتكامل"]},{"title":"ذكاء المستندات","desc":"تحويل المستندات المؤسسية غير المهيكلة إلى بيانات مهيكلة قابلة للتنفيذ — مدمجة مباشرة في سير العمل التشغيلي.","iconName":"FileText","outcomes":["معالجة مستندات متسارعة عبر المشتريات والامتثال","دقة أعلى في استخراج البيانات وتصنيفها","دورات مشتريات وامتثال وإدارة حالات أسرع","تكامل مباشر مع أنظمة تخطيط الموارد والتشغيل"]},{"title":"حوكمة وثقة الذكاء الاصطناعي","desc":"حوكمة مدمجة من المعمارية إلى العمليات — كشف التحيز، قابلية التفسير، مسارات التدقيق، والضوابط التنظيمية.","iconName":"Shield","outcomes":["مسار تدقيق شامل عبر قرارات الذكاء وتغييرات النموذج","كشف التحيز واختبار العدالة عبر الأبعاد الديموغرافية","مواءمة تنظيمية مع SDAIA و NCA و PDPL","سجل نماذج وتحكم بالإصدارات عبر محفظة الذكاء"]},{"title":"هندسة منصة الذكاء وMLOps","desc":"الأساس التشغيلي للذكاء الاصطناعي على نطاق واسع — خطوط أنابيب آلية، مراقبة النماذج، كشف الانحراف، وإعادة التدريب المستمرة.","iconName":"GitBranch","outcomes":["وقت وصول متسارع للإنتاج لحالات الاستخدام الجديدة","مراقبة آلية مع تنبيهات استباقية للانحراف والأداء","خطوط MLOps موحدة عبر فرق علوم البيانات","مخاطر تشغيلية منخفضة من خلال التحقق المستمر"]}];

const whyItems = [{"title":"متعدد المورّدين. بدون احتكار.","desc":"نصمم عبر Salesforce و Google Cloud و IBM و Intel — نختار المنصة المناسبة لكل قدرة بناءً على الملاءمة."},{"title":"الإنتاج أولاً. ليس التجارب.","desc":"كل مشاركة تقاس بالأنظمة العاملة في الإنتاج — مع أسس MLOps والحوكمة المطلوبة للتشغيل المستدام."},{"title":"السياق السعودي. مصمم من البداية.","desc":"متطلبات SDAIA و NCA و PDPL مدمجة في معماريتنا من اليوم الأول."},{"title":"شريك واحد. مساءلة كاملة.","desc":"من تقييم الجاهزية إلى هندسة المنصات إلى العمليات المدارة — علاقة مسؤولة واحدة."}];
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <section className="relative overflow-hidden">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight">
            <span style={{ color: ACCENT }}>الذكاء الاصطناعي من التجريب</span><br />
            إلى التنفيذ المؤسسي.
          </h1>
          <p className="text-lg md:text-xl text-text-muted font-light max-w-3xl mx-auto leading-relaxed">
            نسد الفجوة بين تجارب الذكاء الاصطناعي والأنظمة على مستوى الإنتاج — محكومة، مقاسة، ومبنية للواقع التنظيمي في المملكة العربية السعودية.
          </p>
          </motion.div>
        </section>
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-6">معظم مبادرات الذكاء الاصطناعي لا تغادر مرحلة التجربة.</h2>
        ...
        <motion.section ref={ref2} {...fadeIn} animate={inView2 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link to="/ar/services/advisory" className="group bg-bg-secondary border border-white/5 rounded-xl p-6 hover:border-[#7C3AED]/25 transition-all duration-300 text-right">
              ...
              <h3 className="font-semibold mb-1 group-hover:text-[#7C3AED] transition-colors">الاستشارات والتخطيط</h3>
        ...
        >
          <div className="rounded-2xl p-10 md:p-14 text-center"
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-3">
              ...
              <span style={{ color: '#7C3AED' }}>التجريب إلى التنفيذ</span>؟
            </h2>
            <p className="text-text-muted text-base mb-8 max-w-xl mx-auto leading-relaxed">
              لنناقش كيف يمكن للذكاء الاصطناعي المؤسسي تحقيق نتائج أعمال قابلة للقياس — مع حوكمة مدمجة.
            </p>
