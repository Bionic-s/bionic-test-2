...
const realityItems = [{"iconName":"Users","text":"فرق عمل عالية الكفاءة تستنزف وقتها في مهام تشغيلية متكررة."},{"iconName":"FileText","text":"بيانات حيوية حبيسة مستندات غير مهيكلة."},{"iconName":"GitBranch","text":"مبادرات ذكاء اصطناعي متفرقة تفتقر إلى إطار واضح للتوسع على مستوى المؤسسة."},{"iconName":"Shield","text":"نشر الذكاء الاصطناعي دون حوكمة أو تدقيق أو مواءمة تنظيمية."},{"iconName":"Cpu","text":"نماذج أولية لا ترى النور في بيئة الإنتاج."},{"iconName":"Layers","text":"غياب منهجية واضحة لقياس العائد على الاستثمار وتحقيق القيمة."}];

const coreCaps = [{"title":"استراتيجية وتحول الذكاء الاصطناعي","desc":"تقييم الجاهزية، تحديد أولويات حالات الاستخدام، وخارطة طريق تنفيذ لمدة ١٢ شهرًا — مرتبطة باستراتيجية الأعمال.","iconName":"Layers","outcomes":["خارطة طريق ذكاء اصطناعي مؤسسي مرتبطة بأهداف الأعمال","محفظة حالات استخدام مرتبة حسب التأثير والجدوى","جدوى استثمارية بمؤشرات أداء قابلة للقياس","إطار حوكمة متوافق مع المتطلبات التنظيمية السعودية"]},{"title":"فرق العمل المعززة بالذكاء الاصطناعي","desc":"وكلاء ذكاء اصطناعي يعملون جنبًا إلى جنب مع الفرق البشرية — مع حوكمة بإشراف بشري.","iconName":"Users","outcomes":["تخفيض الجهد اليدوي عبر سير العمل التشغيلي","اتخاذ قرارات متسارع بمساعدة الذكاء الاصطناعي","قدرة تشغيلية قابلة للتوسع دون زيادة متناسبة في التكاليف","تحسين مستمر من خلال تعلم الوكيل والتغذية الراجعة"]},{"title":"الأتمتة الذكية","desc":"أتمتة عمليات معقدة عبر الإدارات بذكاء اصطناعي يفهم السياق — تتجاوز أتمتة العمليات الروبوتية إلى عمليات ذكية.","iconName":"Cpu","outcomes":["تسريع وقت المعالجة في سير العمل عالي الحجم","دقة محسنة في العمليات كثيفة القرار","خفض ملموس للتكاليف في العمليات اليدوية","رؤية على مستوى المؤسسة عبر ذكاء العمليات المتكامل"]},{"title":"ذكاء المستندات","desc":"تحويل المستندات المؤسسية غير المهيكلة إلى بيانات مهيكلة قابلة للتنفيذ — مدمجة مباشرة في سير العمل التشغيلي.","iconName":"FileText","outcomes":["معالجة مستندات متسارعة عبر المشتريات والامتثال","دقة أعلى في استخراج البيانات وتصنيفها","دورات مشتريات وامتثال وإدارة حالات أسرع","تكامل مباشر مع أنظمة تخطيط الموارد والتشغيل"]},{"title":"حوكمة الذكاء الاصطناعي وتعزيز الثقة الرقمية","desc":"حوكمة مدمجة من المعمارية إلى العمليات — كشف التحيز، قابلية التفسير، مسارات التدقيق، والضوابط التنظيمية.","iconName":"Shield","outcomes":["مسار تدقيق شامل عبر قرارات الذكاء وتغييرات النموذج","كشف التحيز واختبار العدالة عبر الأبعاد الديموغرافية","مواءمة تنظيمية مع SDAIA و NCA و PDPL","سجل نماذج وتحكم بالإصدارات عبر محفظة الذكاء"]},{"title":"هندسة منصات الذكاء الاصطناعي وعمليات النماذج","desc":"الأساس التشغيلي للذكاء الاصطناعي على نطاق واسع — خطوط أنابيب آلية، مراقبة النماذج، كشف الانحراف، وإعادة التدريب المستمرة.","iconName":"GitBranch","outcomes":["وقت وصول متسارع للإنتاج لحالات الاستخدام الجديدة","مراقبة آلية مع تنبيهات استباقية للانحراف والأداء","خطوط MLOps موحدة عبر فرق علوم البيانات","تخفيض المخاطر التشغيلية من خلال التحقق المستمر"]}];

const whyItems = [{"title":"متعدد المورّدين. بدون احتكار.","desc":"نصمم عبر Salesforce و Google Cloud و IBM و Intel — نختار المنصة المناسبة لكل قدرة بناءً على الملاءمة."},{"title":"الإنتاج أولاً. ليس التجارب.","desc":"نقيس نجاحنا بنتائج فعلية في البيئات التشغيلية — مع أسس MLOps والحوكمة المطلوبة للتشغيل المستدام."},{"title":"مصمم بما يتوافق مع البيئة التنظيمية في المملكة منذ اليوم الأول.","desc":"متطلبات SDAIA و NCA و PDPL مدمجة في معماريتنا من اليوم الأول."},{"title":"شريك واحد يتحمل المسؤولية الكاملة.","desc":"من تقييم الجاهزية إلى هندسة المنصات إلى العمليات المدارة — علاقة مسؤولة واحدة."}];
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <section className="relative overflow-hidden">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight">
            <span style={{ color: ACCENT }}>الذكاء الاصطناعي من مرحلة التجارب</span><br />
            إلى التبني المؤسسي واسع النطاق.
          </h1>
          <p className="text-lg md:text-xl text-text-muted font-light max-w-3xl mx-auto leading-relaxed">
            نحول مبادرات الذكاء الاصطناعي من النماذج الأولية إلى حلول تشغيلية تحقق قيمة فعلية للأعمال — محكومة بأطر واضحة ومقاسة بنتائج فعلية ومتوافقة مع الواقع التنظيمي في المملكة العربية السعودية.
          </p>
          </motion.div>
        </section>
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-6">معظم مبادرات الذكاء الاصطناعي لا تتجاوز مرحلة إثبات القيمة.</h2>
