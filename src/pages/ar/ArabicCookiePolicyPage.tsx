...
export default function Page() {
  return (
    <div
      ...
      <Helmet>
        <title>سياسة ملفات تعريف الارتباط | بيونك سوليوشنز</title>
        <meta name="description" content="سياسة ملفات تعريف الارتباط لبيونك سوليوشنز — كيف نستخدم ملفات تعريف الارتباط والتقنيات المماثلة لتحسين تجربتك." />
      </Helmet>
