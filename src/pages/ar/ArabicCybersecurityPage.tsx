      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="inline-flex items-center px-4 py-2 rounded-full border mb-10"
            style={{ borderColor: '#DC262640', backgroundColor: '#DC262608' }}>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight">
            <span className="bg-gradient-to-r from-[#DC2626] via-[#F87171] to-white bg-clip-text text-transparent">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl px-5 py-4 transition-all duration-300 flex items-center gap-3 hover:border-[#DC262630] flex-row-reverse">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: '#DC262615', color: ACCENT }}>{item.icon}</div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                outcomes: ['مراقبة أمنية 24×7 مع تصعيد واستجابة محدَّدين', 'تحقق مستمر من الضوابط عبر اختبار آلي وفرق هجومية حمراء', 'مراقبة تغيرات تنظيمية تضمن امتثالًا مستمرًا للمتطلبات المتطورة', 'خارطة طريق نضج أمني بمراحل تحسين ربع سنوية'],
              },
            ].map((cap, i) => (
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl p-6 transition-all duration-300 hover:border-[#DC26261A]">
                <div className="flex flex-col md:flex-row md:items-start gap-5 flex-row-reverse">
                  <div className="flex-shrink-0 w-11 h-11 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: '#DC262612', color: ACCENT }}>{cap.icon}</div>
        ...
        <motion.section ref={ref2} {...fadeIn} animate={inView2 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link to="/ar/services/advisory" className="group bg-bg-secondary border border-white/5 rounded-xl p-6 hover:border-[#DC2626]/25 transition-all duration-300 text-right">
              <div className="w-10 h-10 rounded-lg bg-[#DC2626]/10 flex items-center justify-center mb-3 text-[#DC2626]">
              ...
              <h3 className="font-semibold mb-1 group-hover:text-[#DC2626] transition-colors">الاستشارات والتخطيط</h3>
            ...
            <Link to="/ar/services/implementation" className="group bg-bg-secondary border border-white/5 rounded-xl p-6 hover:border-[#DC2626]/25 transition-all duration-300 text-right">
              <div className="w-10 h-10 rounded-lg bg-[#DC2626]/10 flex items-center justify-center mb-3 text-[#DC2626]">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
              </div>
              <h3 className="font-semibold mb-1 group-hover:text-[#DC2626] transition-colors">التنفيذ والتسليم</h3>
              <p className="text-tiny text-text-muted">نشر الذكاء الاصطناعي والأتمتة · تسليم المنصات والتطبيقات · خط أنابيب MLOps</p>
            </Link>
            <Link to="/ar/services/operations" className="group bg-bg-secondary border border-white/5 rounded-xl p-6 hover:border-[#DC2626]/25 transition-all duration-300 text-right">
              <div className="w-10 h-10 rounded-lg bg-[#DC2626]/10 flex items-center justify-center mb-3 text-[#DC2626]">
              ...
              <h3 className="font-semibold mb-1 group-hover:text-[#DC2626] transition-colors">العمليات المدارة</h3>
        ...
        <motion.section ref={ref3} {...fadeIn} animate={inView3 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          <div className="rounded-2xl p-10 md:p-12 text-right"
            style={{ background: 'linear-gradient(135deg, #DC262608, var(--bg-secondary), var(--bg-secondary))', border: '1px solid #DC26261A' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                { title: 'شريك واحد. مساءلة كاملة.', desc: 'من استراتيجية الأمن مرورًا بعمليات مركز العمليات الأمنية إلى الأمن المدار — علاقة واحدة مسؤولة عبر دورة حياة الأمن والمرونة الكاملة.' },
              ].map((item, i) => (
        ...
        <motion.section ref={ref5} {...fadeIn} animate={inView5 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { industry: 'القطاع المصرفي والمالي', apps: 'إطار المرونة السيبرانية للبنك المركزي، كشف الاحتيال، أمن SWIFT، التقارير التنظيمية.' },
              ...
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl p-5 transition-all duration-300 hover:border-[#DC26261A] text-right">
        ...
        <motion.section ref={ref6} {...fadeIn} animate={inView6 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl p-6 transition-all duration-300 hover:border-[#DC262612] text-right">
                <span className="text-xs font-semibold px-3 py-1 rounded-full mb-4 inline-block"
                  style={{ backgroundColor: '#DC262612', color: ACCENT }}>{item.tag}</span>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <Link key={i} to={`/ar/blueprints/${bp.slug}`} className="group bg-bg-secondary border border-white/5 rounded-xl p-5 hover:border-[#DC2626]/25 transition-all duration-300 text-right">
          ...
          <div className="mt-4 text-center">
            <Link to="/ar/blueprints?capability=cyber" className="inline-flex items-center gap-1.5 text-[#DC2626] text-sm font-medium hover:underline">
        ...
        >
          <div className="rounded-2xl p-10 md:p-14 text-center"
            style={{ background: 'linear-gradient(135deg, #DC26260D, var(--bg-secondary), var(--bg-secondary))', border: '1px solid #DC26261A' }}>
            <h2 className="text-2xl md:text-4xl font-bold mb-3">
              هل أنتم مستعدون للانتقال من الأمن التفاعلي إلى<br />
              <span className="bg-gradient-to-r from-[#DC2626] to-[#F87171] bg-clip-text text-transparent">المرونة السيبرانية</span>؟
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                style={{ backgroundColor: ACCENT, boxShadow: '0 8px 24px #DC262620' }}>
                ابدأ المحادثة
