    ...
    <div className="min-h-screen bg-bg-primary pt-32 pb-24" dir="rtl">
      <div className="container mx-auto px-4 lg:px-12 max-w-4xl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="text-center mb-16">
          ...
          <p className="text-text-muted max-w-2xl mx-auto leading-relaxed">منظومة الذكاء الاصطناعي الكاملة — من المحمول إلى السحابة. نوفر منظومة متكاملة من المنتجات والحلول التقنية عبر ثلاث ركائز: الذكاء، الأتمتة، والثقة.</p>
        </motion.div>
