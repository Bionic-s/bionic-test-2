          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <h1 style={{ fontSize: 'clamp(2.5rem, 3.5vw, 3.5rem)', lineHeight: '1.12', fontWeight: 700, marginBottom: '0.5rem', letterSpacing: '-0.02em', fontFamily: "'Tajawal', sans-serif" }}>
              <span className="bg-gradient-to-r from-[#2563EB] via-[#60A5FA] to-white bg-clip-text text-transparent">
                مُمكّن التحول المؤسسي للذكاء الاصطناعي
              </span>
            </h1>
            <p className="text-lg md:text-xl text-text-muted font-light max-w-3xl mx-auto leading-relaxed mt-8" style={{ fontFamily: "'Tajawal', sans-serif" }}>
              نصمم الذكاء والأتمتة والثقة في صميم الأعمال — نساعد المؤسسات على تحويل العمليات وتجارب العملاء
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
            {[
              { icon: Layers, color: '#2563EB', title: 'الاستراتيجية والمعمارية', desc: 'نرسم الحالة الراهنة، ونحدد المعمارية المستهدفة، ونبني دراسة الجدوى — المرتكزة على الواقع التنظيمي السعودي.' },
              { icon: Zap, color: '#7C3AED', title: 'التنفيذ والتسليم', desc: 'نشر المنصات، وهندسة التكامل، وتمكين التبني — بمورّدين متعددين، ومجالات متعددة، ومساءلة واحدة.' },
              { icon: CheckCircle, color: '#059669', title: 'العمليات المُدارة', desc: 'مراقبة 24×7، وعمليات الذكاء الاصطناعي، والتحسين المستمر — نبقى معكم لفترة طويلة بعد التشغيل.' },
            ].map((item, i) => (
          ...
          <div className="max-w-3xl mx-auto space-y-5 text-text-muted leading-relaxed text-base bg-bg-secondary/50 rounded-xl border border-white/5 p-8" style={{ fontFamily: "'Tajawal', sans-serif" }}>
            <p>
              بيونك سوليوشنز هي مُمكّن التحول المؤسسي للذكاء الاصطناعي — أُنشئت في المملكة العربية السعودية، وتعمل عبر المملكة.
              نعمل مع الجهات الحكومية والبنوك والمشغلين الصناعيين ومقدمي الرعاية الصحية والمؤسسات الكبرى — ضمن البيئة التنظيمية السعودية:
              مشتريات اعتماد، وضوابط الأمن السيبراني للهيئة الوطنية للأمن السيبراني، وأطر امتثال البنك المركزي السعودي، وحماية البيانات الشخصية PDPL.
            </p>
            <p>
            ...
            <p className="text-sm text-text-muted/60">
              لا ننشر أسماء العملاء أو تفاصيل المشاريع أو مقاييس محددة — أعمال التحول حساسة تجاريًا. يمكن مناقشة خبرتنا
              بالتفصيل خلال جلسة الاستراتيجية، في حدود سرية العميل.
            </p>
          </div>
        </motion.section>
          ...
          <div className="rounded-2xl p-10 md:p-14 relative overflow-hidden"
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { icon: Target, title: 'خبرة التحول المؤسسي', desc: 'لا نبيع منتجات. نصمم النتائج — نؤلف الاستراتيجية والتقنية والبيانات والحوكمة في برامج تحول تقاس بالأداء المؤسسي.' },
                  { icon: Layers, title: 'قيادة منظومة متعددة المورّدين', desc: 'لسنا مقيدين بخارطة طريق أي مورد. نصمم عبر أهم منصات التقنية في العالم — نختار وندمج ما يحقق أقصى قيمة للأعمال.' },
                  { icon: Shield, title: 'مساءلة شاملة من البداية للنهاية', desc: 'من التقييم إلى المعمارية إلى العمليات والتطور المستمر — شريك واحد مسؤول عبر دورة حياة التحول الكاملة.' },
                  { icon: Globe, title: 'المواءمة مع رؤية 2030', desc: 'كل مشاركة ترتكز على أولويات التحول الوطني للمملكة — السيادة، والحكومة الرقمية، والتحديث الصناعي، وتنمية القدرات البشرية.' },
                ].map((item, i) => (
          ...
          <div className="rounded-2xl p-10 md:p-14 border relative overflow-hidden"
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="text-2xl md:text-3xl font-bold" style={{ fontFamily: "'Tajawal', sans-serif" }}>جذور سعودية. سيادة أولاً. نتائج ملموسة.</h2>
              </div>
              <p className="text-text-muted text-lg mb-10 max-w-3xl leading-relaxed" style={{ fontFamily: "'Tajawal', sans-serif" }}>
                المملكة العربية السعودية ليست مجرد سوق نخدمه. إنها السياق الاستراتيجي الذي يحدد معماريتنا
                وأولوياتنا وغايتنا. كل مشاركة لبيونك تُبنى على التزامات تجاه تحول المملكة.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[
                  { icon: Cpu, title: 'الذكاء السيادي', desc: 'أنظمة ذكاء اصطناعي مصممة ومنشورة داخل حدود البيانات السعودية، محكومة بمبادئ أخلاقيات الذكاء الاصطناعي لدى SDAIA، ومتوافقة مع الاستراتيجية الوطنية للذكاء الاصطناعي.' },
                  { icon: Building2, title: 'الحكومة الرقمية', desc: 'منصات وقدرات تمكّن خدمات رقمية متمحورة حول المواطن، وتكامل مشتريات اعتماد، وتبادل البيانات بين الجهات الحكومية.' },
                  { icon: Zap, title: 'التحديث الصناعي', desc: 'بنية تحتية وأتمتة وذكاء يحدّث الصناعة السعودية — من التصنيع والطاقة إلى اللوجستيات والرعاية الصحية.' },
                  ...
                  { icon: Shield, title: 'السيادة السيبرانية', desc: 'معماريات أمنية متوافقة مع الضوابط الأساسية للأمن السيبراني NCA، وإطار المرونة السيبرانية للبنك المركزي السعودي، ومتطلبات حماية البيانات الشخصية PDPL.' },
                  { icon: Target, title: 'التحول الوطني', desc: 'كل مشاركة تساهم في تحقيق أهداف رؤية 2030 نحو اقتصاد سعودي متنوع ورقمي وتنافسي عالميًا.' },
                ].map((item, i) => (
        ...
        <motion.section ref={ref4} {...fadeIn} animate={inView4 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            {[
              { city: 'الرياض', region: 'مقر المنطقة الوسطى', desc: 'خدمة القطاع الحكومي والبنوك والمؤسسات في العاصمة والمنطقة الوسطى.' },
              { city: 'جدة', region: 'مكتب المنطقة الغربية', desc: 'خدمة المنطقة الغربية وساحل البحر الأحمر — موقع التأسيس ومركز العمليات.' },
              { city: 'الدمام', region: 'مكتب المنطقة الشرقية', desc: 'خدمة قطاع النفط والغاز والصناعة واللوجستيات في المنطقة الشرقية.' },
            ].map((office, i) => (
          ...
          <div className="rounded-2xl p-10 md:p-14 relative overflow-hidden"
            ...
            <div className="relative z-10">
              ...
              <p className="text-text-muted text-lg mb-10 max-w-2xl mx-auto leading-relaxed" style={{ fontFamily: "'Tajawal', sans-serif" }}>
                كل تحول يبدأ بمحادثة حول موقعكم الحالي، وإلى أين تحتاجون الوصول، وما يتطلبه الطريق.
                ليس عرض مبيعات. نقاش معماري.
              </p>
              <Link
                to="/ar/contact"
