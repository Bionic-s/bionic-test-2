...
export default function Page() {
  return (
    <div
      ...
      <Helmet>
        <title>سياسة الخصوصية | بيونك سوليوشنز</title>
        <meta name="description" content="سياسة خصوصية بيونك سوليوشنز — كيف نجمع ونستخدم ونحمي البيانات الشخصية وفقًا لنظام حماية البيانات الشخصية السعودي والمعايير الدولية." />
      </Helmet>
