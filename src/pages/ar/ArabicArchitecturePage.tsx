...
const ACCENT = '#00BFFF';
const HERO_BG = '/images/hero/ai-agents.avif';
...
const layers = [
  ...
  },
  {
    ...
    items: ['الاستشارات والتخطيط: الاستراتيجية، المعمارية، خرائط الطريق', 'التنفيذ والتسليم: النشر، التكامل، التبني', 'العمليات المُدارة: تشغيل على مدار الساعة، هندسة موثوقية الأنظمة، AIOps، تحسين مستمر'],
...
export default function ArabicArchitecturePage() {
  ...
  return (
    <div
      ...
      <Helmet>
        <title>الهندسة المعمارية | بيونك سوليوشنز — مُمكّن التحول المؤسسي بالذكاء الاصطناعي</title>
        <meta name="description" content="منهجيتنا المعمارية من 10 طبقات توحّد الاستراتيجية والقدرات والخدمات والقطاعات والحوكمة في نظام تشغيلي متكامل." />
      </Helmet>
