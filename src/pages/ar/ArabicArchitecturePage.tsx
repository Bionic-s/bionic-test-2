...
const layers = [
  ...
  },
  {
    ...
    items: ['منصات البيانات: بحيرة البيانات، النسيج، التدفق', 'MDM: رؤية 360 للعميل، المواطن، الأصول، المريض', 'حوكمة البيانات: الجودة، النسب، الكتالوج', 'التحليلات والذكاء: لوحات معلومات، خدمة ذاتية، مضمنة', 'بيانات جاهزة للذكاء: مخازن الخصائص، قواعد البيانات المتجهة، خطوط الأنابيب'],
