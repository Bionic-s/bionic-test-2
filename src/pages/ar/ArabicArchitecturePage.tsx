...
const layers = [
  {
    ...
    icon: Target,
    title: 'نتائج الأعمال',
    subtitle: 'ما الذي يتغير عندما ينجح التحول؟',
    ...
    link: { label: 'استكشف نظام القيمة المؤسسية', to: '/ar/value' },
  },
  {
    num: 2,
    icon: TrendingUp,
    title: 'نظام القيمة المؤسسية',
    subtitle: 'كيف تتراكم القيمة عبر أربعة آفاق؟',
    desc: 'تتراكم القيمة عبر أربعة آفاق — تحسين التكاليف (0-12 شهرًا)، خفض المخاطر (6-18 شهرًا)، نمو الإيرادات (12-36 شهرًا)، والريادة السوقية (24-60 شهرًا).',
    items: ['تحسين التكاليف: 0-12 شهرًا', 'خفض المخاطر: 6-18 شهرًا', 'نمو الإيرادات: 12-36 شهرًا', 'الريادة السوقية: 24-60 شهرًا'],
    link: { label: 'استكشف نظام القيمة المؤسسية', to: '/ar/value' },
  },
  {
    num: 3,
    ...
    desc: 'خمسة قطاعات منظمة حيث تحل معماريتنا تحديات صناعية حقيقية — القطاع الحكومي، البنوك، النفط والغاز، الرعاية الصحية، والمؤسسات عبر القطاعات.',
  ...
  },
  {
    ...
    title: 'الخدمات',
    subtitle: 'كيف ننفذ؟',
    desc: 'ثلاثة نماذج تنفيذ — الاستشارات، التنفيذ، والعمليات المُدارة — تتكامل حسب الحاجة عبر كل قطاع وقدرة.',
    items: ['الاستشارات والتخطيط: الاستراتيجية، المعمارية، خرائط الطريق', 'التنفيذ والتسليم: النشر، التكامل، التبني', 'العمليات المُدارة: تشغيل 24×7، هندسة موثوقية المواقع، AIOps، تحسين مستمر'],
  ...
  },
  {
    ...
    items: ['12 مخططًا عبر 5 قطاعات', 'وصول مزدوج: من القطاعات ومن القدرات', 'تخطيط كامل: قطاع، قدرة، خدمات، شركاء، منتجات'],
  ...
  },
  {
    ...
    subtitle: 'ما التقنية التي تشغّل التحول؟',
  ...
  },
  {
    ...
    desc: 'منصات بيانات موحدة ومحكومة وجاهزة للذكاء الاصطناعي — معماريات نسيج البيانات وبحيرة البيانات، إدارة البيانات الرئيسية، حوكمة متوافقة مع PDPL، ومحركات تحليلية تغذي كل طبقة أعلاه.',
    items: ['منصات البيانات: بحيرة البيانات، النسيج، التدفق', 'MDM: رؤية 360 للعميل، المواطن، الأصول، المريض', 'حوكمة البيانات: الجودة، النسب، الكتالوج', 'التحليلات والذكاء: لوحات معلومات، خدمة ذاتية، مضمنة', 'بيانات جاهزة للذكاء الاصطناعي: مستودعات الخصائص، قواعد البيانات المتجهة، مسارات البيانات'],
  ...
  },
  {
    ...
    subtitle: 'ما هو أساس الثقة؟',
    desc: 'بنية تحتية سيادية مصممة للثقة — حوسبة وتخزين Dell، تسريع ذكاء Intel، منصات سحابية من Platform9 وRed Hat، تعافٍ سيبراني، وعمليات أمنية متوافقة مع NCA.',
    items: ['الحوسبة: Dell PowerEdge، Intel Xeon، Gaudi AI', 'التخزين: PowerStore، PowerMax، FlashSystem', 'السحابة: Platform9 K8s، Red Hat OpenShift', 'التعافي السيبراني: خزنة معزولة، ثبات البيانات', 'الأمن: QRadar SOC، Zero Trust، متوافق مع NCA'],
  ...
  },
  {
    ...
    desc: 'العمليات تحمي وتراكم القيمة ربعًا بعد ربع — AIOps، هندسة موثوقية المواقع، FinOps، SOC كخدمة، ومراجعات تحسين مستمر ربع سنوية.',
    items: ['AIOps والمراقبة: Instana + Turbonomic', 'هندسة موثوقية المواقع: ميزانيات الأخطاء، SLOs، تحليل postmortem', 'FinOps: رؤية التكاليف، chargeback، التحسين', 'SOC كخدمة: أمن 24×7، صيد التهديدات', 'التحسين المستمر: مراجعات ربع سنوية، تحسين مقاس'],
        ...
        >
          <div className="container mx-auto max-w-4xl">
            ...
            <p className="text-text-muted text-lg max-w-[720px] leading-relaxed" style={{ fontFamily: "'Tajawal', sans-serif" }}>
              10 طبقات مترابطة. نهج متكامل واحد. من نتائج الأعمال إلى التحسين المستمر —
              هكذا نصمم وننفذ ونستدام التحول المؤسسي للمملكة العربية السعودية.
            </p>
          </div>
        </motion.div>
      </section>
        ...
        >
          <div className="bg-bg-secondary border border-white/5 rounded-2xl p-8 md:p-12">
            ...
            <div className="text-lg text-text-muted leading-relaxed space-y-3" style={{ fontFamily: "'Tajawal', sans-serif" }}>
              <p><strong className="text-text-primary">نتائج الأعمال</strong> تحدد <em>لماذا</em> نتحول.</p>
              <p><strong className="text-text-primary">نظام القيمة المؤسسية</strong> يحدد <em>كيف تتراكم القيمة</em> عبر الزمن.</p>
              <p><strong className="text-text-primary">القطاعات</strong> تحدد <em>أين</em> — السياق التنظيمي والتنافسي.</p>
              <p><strong className="text-text-primary">القدرات</strong> تحدد <em>ماذا</em> نفعل — سبعة مجالات متكاملة.</p>
              <p><strong className="text-text-primary">الخدمات</strong> تحدد <em>كيف</em> ننفذ — ثلاثة نماذج متداخلة.</p>
              <p><strong className="text-text-primary">مخططات التحول</strong> تثبت <em>أنها تعمل</em> — 12 معمارية مرجعية.</p>
              <p><strong className="text-text-primary">التطبيقات والمنصات</strong> تقدم <em>التقنية</em>.</p>
              <p><strong className="text-text-primary">البيانات والذكاء</strong> تغذي <em>كل ما فوقها</em>.</p>
          ...
          <div className="bg-bg-secondary border border-white/5 rounded-2xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-text-muted text-lg leading-relaxed mb-8 max-w-[720px]" style={{ fontFamily: "'Tajawal', sans-serif" }}>
                ...
                صفحات القدرات تركّز على الطبقة 4. صفحات القطاعات تركّز على الطبقة 3. صفحات الخدمات تركّز على الطبقة 5.
                المخططات تربط الطبقات 3-6. نظام القيمة المؤسسية هو الطبقة 2.
                صفحة المعمارية هذه هي النسيج الرابط — الرؤية الواحدة التي تظهر كيف يتكامل كل شيء.
              </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-2xl md:text-4xl font-bold mb-4" style={{ fontFamily: "'Tajawal', sans-serif" }}>
                هل أنتم مستعدون لرؤية هذه المعمارية مطبقة على مؤسستكم؟
              </h2>
