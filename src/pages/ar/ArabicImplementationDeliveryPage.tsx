...
const services = [
  { title: 'تطبيق الذكاء الاصطناعي والأتمتة', desc: 'خط أنابيب MLOps، بنية تقديم النماذج، تطبيق الوكلاء، تنفيذ أتمتة سير العمل — بجودة إنتاجية، محكومة، وقابلة للقياس.', icon: Zap },
        ...
        >
          <div className="container mx-auto px-4 lg:px-12 max-w-6xl">
            ...
            <p className="text-text-muted text-lg max-w-[720px] mx-auto leading-relaxed">
              المعمارية نظرية. الإنتاج هو الحقيقة. نطبق وندمج ونسلّم — ولكن الأهم أننا نضمن أن تتبنى فرقكم، وتستوعب عملياتكم، وتحقق أعمالكم القيمة الموعودة. من منصات الذكاء الاصطناعي إلى ضوابط الأمن، من CRM إلى السحابة — تسليم بجودة إنتاجية مع تسريع مدمج للوقت إلى القيمة.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl pb-24">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            الفجوة بين "تم النشر" و"تحقيق القيمة" هي حيث تتعثر معظم التحولات.
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              { pre: 'مقبرة التجارب الأولية', text: 'مشاريع الذكاء الاصطناعي والأتمتة تتوقف بين النموذج الأولي والإنتاج — لا خط أنابيب تطبيق، لا جاهزية تشغيلية' },
              ...
              { pre: 'الأمن يُضاف لاحقًا', text: 'ضوابط سيبرانية تُطبق بعد التطبيق، لا كمكون معماري مدمج في خط أنابيب التسليم — مما يسبب إعادة عمل مكلفة' },
