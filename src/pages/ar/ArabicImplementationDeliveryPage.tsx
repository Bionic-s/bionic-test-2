...
const services = [
  { title: 'نشر الذكاء الاصطناعي والأتمتة', desc: 'خط أنابيب MLOps، بنية تقديم النماذج، نشر الوكلاء، تنفيذ أتمتة سير العمل — بجودة إنتاجية، محكومة، وقابلة للقياس.', icon: Zap },
  { title: 'تسليم المنصات والتطبيقات', desc: 'نشر CRM (Salesforce)، بناء منصة البيانات (IBM، Informatica)، نشر ذكاء الأعمال (Tableau، Looker)، تحديث التطبيقات.', icon: Cog },
  ...
  { title: 'تسليم البنية التحتية والسحابة', desc: 'تحديث مراكز البيانات (Dell)، نشر السحابة الهجينة (Platform9، Red Hat OpenShift)، بناء البنية التحتية السيادية.', icon: Cloud },
  { title: 'تنفيذ الأمن السيبراني', desc: 'نشر نسيج Zero Trust، بناء مركز العمليات الأمنية (IBM QRadar)، مخزن التعافي السيبراني (Dell PowerProtect)، معمارية الهوية.', icon: Shield },
...
const capabilityCoverage = [
  { cap: 'الذكاء الاصطناعي المؤسسي والأتمتة', app: 'خط أنابيب MLOps، نشر النماذج، نشر الوكلاء، تنفيذ أتمتة سير العمل' },
        ...
        >
          <div className="container mx-auto px-4 lg:px-12 max-w-6xl">
            ...
            <p className="text-text-muted text-lg max-w-[720px] mx-auto leading-relaxed">
              المعمارية نظرية. الإنتاج هو الحقيقة. ننشر وندمج ونسلّم — ولكن الأهم أننا نضمن أن فرقكم تتبنى، وعملياتكم تستوعب، وأعمالكم تحقق القيمة الموعودة. من منصات الذكاء الاصطناعي إلى ضوابط الأمن، من CRM إلى السحابة — تسليم بجودة إنتاجية مع تسريع مدمج للوقت إلى القيمة.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <div className="container mx-auto px-4 lg:px-12 max-w-6xl pb-24">
        ...
        <motion.section ref={ref1} {...fadeIn} animate={inView1 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            الفجوة بين "تم النشر" و"يحقق قيمة" هي حيث تفشل معظم التحولات.
          </h2>
          <p className="text-text-muted mb-8 max-w-[720px]">
            تشير الأبحاث إلى أن مشاريع التقنية في المؤسسات الكبرى تتجاوز الجداول الزمنية الأولية بشكل روتيني — منهجية التسليم المنضبطة تسد هذه الفجوة. التجارب الأولية للذكاء الاصطناعي لا تصل أبدًا إلى الإنتاج. منصات جديدة تُنشر لكن الفرق لا تستطيع تشغيلها. نحن نسد هذه الفجوة — بتسليم أنظمة بجودة إنتاجية مع حوكمة وتبني وتتبع قيمة مدمجة في العملية.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              { pre: 'مطهر التجارب الأولية', text: 'مشاريع الذكاء الاصطناعي والأتمتة تتوقف بين النموذج الأولي والإنتاج — لا خط أنابيب نشر، لا جاهزية تشغيلية' },
              { pre: 'تعقيد التكامل', text: 'المنصات الجديدة يجب أن تتصل بالأنظمة القديمة — SAP و Oracle والتطبيقات المخصصة — دون كسر ما يعمل' },
              { pre: 'تأخيرات التسليم', text: 'مشاريع المؤسسات تتجاوز الجدول الزمني بشكل روتيني — لا انضباط أجايل للنشر على مستوى المؤسسة' },
              { pre: 'الأمن يُضاف لاحقًا', text: 'ضوابط سيبرانية تُطبق بعد النشر، وليس كمكون معماري مدمج في خط أنابيب التسليم — إعادة عمل مكلفة' },
              { pre: 'تبادل الاتهامات بين المورّدين', text: 'بيئات متعددة المورّدين تخلق فجوات في المساءلة — لا يوجد طرف واحد يمتلك نجاح التسليم' },
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {blueprints.map((bp, i) => (
              <Link key={i} to={`/ar/blueprints/${bp.slug}`} className="group bg-bg-secondary border border-white/5 rounded-xl p-5 hover:border-[#059669]/25 transition-all duration-300">
                ...
                <ArrowRight className="w-4 h-4 text-[#059669]/40 group-hover:text-[#059669] group-hover:-translate-x-1 transition-all mt-2 rotate-180" />
              </Link>
            ))}
          </div>
          <div className="mt-4 text-center">
            <Link to="/ar/blueprints" className="inline-flex items-center gap-1.5 text-[#059669] text-sm font-medium hover:underline">
        ...
        <motion.section ref={ref5} {...fadeIn} animate={inView5 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { title: 'مالك تسليم واحد', desc: 'ندير جميع المورّدين. تحصل على فريق واحد مسؤول، وليس خمسة مدراء مشاريع يتبادلون الاتهامات.' },
              { title: 'سلسلة الاستراتيجية إلى القيمة', desc: 'الفريق الذي قدّم الاستشارة هو الذي يبني. الفريق الذي يبني يضمن التبني. التبني يُقاس مقابل نتائج الأعمال.' },
              ...
              { title: 'البناء حتى التبني', desc: 'التسليم يشمل إدارة التغيير والتدريب وأدلة التشغيل وخطوط أساس مؤشرات الأداء. لا "نرمي فوق الجدار".' },
            ].map((item, i) => (
              <div key={i} className="bg-bg-secondary border border-white/5 rounded-xl p-5 hover:border-[#059669]/25 transition-all duration-300">
                <h3 className="font-semibold text-sm mb-2">{item.title}</h3>
                <p className="text-tiny text-text-muted leading-relaxed">{item.desc}</p>
        ...
        >
          <div className="bg-bg-secondary border border-white/5 rounded-2xl p-8 md:p-12 text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-4">
              هل أنت مستعد لنقل تحولكم من التصميم إلى الإنتاج؟
            </h2>
