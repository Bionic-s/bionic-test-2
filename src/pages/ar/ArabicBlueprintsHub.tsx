...
const HERO_BG = '/images/optimized/blueprints-hero.webp';
        ...
        >
          <div className="container mx-auto px-4 lg:px-12 max-w-6xl">
            ...
            <p className="text-xl text-text-muted max-w-3xl mx-auto">
              معماريات مرجعية تطبيقية مبنية على منظومة بيونك الاستراتيجية — تربط القطاعات والقدرات والشركاء والمنتجات في مخططات تحول مثبتة في بيئات إنتاجية حقيقية.
            </p>
          </div>
        </motion.div>
      </section>
