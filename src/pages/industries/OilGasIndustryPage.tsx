...
export default function OilGasIndustryPage() {
  ...
  return (
    <div
      ...
      <Helmet>
        <title>Oil & Gas | Bionic Solutions — Enterprise AI Transformation Integrator</title>
        <meta name="description" content="AI transformation for oil & gas — predictive maintenance, HSE compliance, OT data intelligence." />
      </Helmet>
      {/* ═══ 1. HERO SECTION — Full-width background ═══ */}
        ...
        <motion.section ref={ref4} {...fadeIn} animate={inView4 ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 }} className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[480px]">
            {blueprints.map((bp, i) => (
              <Link key={i} to={`/blueprints/${bp.slug}`} className="group bg-bg-secondary border border-white/5 rounded-xl p-5 hover:border-[#00BFFF]/25 transition-all duration-300">
                <span className="text-tiny text-[#00BFFF]/60 mb-2 block">Oil & Gas</span>
          ...
          <div className="mt-4">
            <Link to="/blueprints?industry=oil-gas" className="inline-flex items-center gap-1.5 text-[#00BFFF] text-sm font-medium hover:underline">
        ...
        >
          <div className="bg-bg-secondary border border-white/5 rounded-2xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link to="/blueprints?industry=oil-gas" className="inline-flex items-center gap-2 px-7 py-3.5 border border-white/10 text-text-primary font-medium rounded-xl transition-all duration-300 hover:border-[#00BFFF]/30">
