...
export default function GovernmentIndustryPage() {
  ...
  return (
    <div
      ...
      <Helmet>
        <title>Government | Bionic Solutions — Enterprise AI Transformation Integrator</title>
        <meta name="description" content="AI transformation for Saudi government — Etimad procurement intelligence, citizen service automation, national-scale document AI." />
      </Helmet>
