...
export const blueprints: Blueprint[] = [
  // ── Government ──────────────────────────────────────────
  {
    ...
    partners: ['IBM', 'Dell Technologies', 'Intel', 'Platform9'],
  ...
  },
  {
    ...
    serviceSlugs: ['advisory', 'implementation', 'operations'],
    partners: ['Dell Technologies', 'IBM', 'Intel', 'Platform9'],
...
export const allBlueprintPartners = [
  ...
  'Salesforce', 'MuleSoft', 'Informatica', 'Tableau', 'Google',
];
