...
export const blueprints: Blueprint[] = [
  ...
  },
  {
    ...
    serviceSlugs: ['advisory', 'implementation', 'operations'],
    partners: ['Informatica', 'Google Cloud', 'MuleSoft', 'Tableau'],
  ...
  },
  {
    ...
    serviceSlugs: ['advisory', 'implementation', 'operations'],
    partners: ['Dell Technologies', 'IBM', 'Red Hat', 'Intel', 'Platform9'],
  ...
  // ── Healthcare ─────────────────────────────────────────
  {
    ...
    services: ['AI Readiness Assessment', 'Platform & App Delivery', 'Managed Operations'],
    serviceSlugs: ['advisory', 'implementation', 'operations'],
    partners: ['Salesforce', 'Google Cloud', 'Informatica', 'MuleSoft'],
  ...
  },
  {
    ...
    services: ['AI Readiness Assessment', 'AI & Automation Deployment', 'Managed Operations'],
    serviceSlugs: ['advisory', 'implementation', 'operations'],
    partners: ['IBM', 'Google Cloud', 'Dell Technologies', 'Intel', 'Platform9'],
  ...
  // ── Enterprise ─────────────────────────────────────────
  {
    ...
    services: ['AI Readiness Assessment', 'AI & Automation Deployment', 'Managed Operations'],
    serviceSlugs: ['advisory', 'implementation', 'operations'],
    partners: ['Salesforce', 'IBM', 'Google Cloud', 'MuleSoft'],
...
export const allBlueprintPartners = [
  'IBM', 'Dell Technologies', 'Intel', 'Red Hat', 'Platform9',
  'Salesforce', 'MuleSoft', 'Informatica', 'Tableau', 'Google Cloud',
];
