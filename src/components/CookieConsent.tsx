...
const t = {
  ...
  ar: {
    ...
    body: 'نستخدم ملفات تعريف ارتباط ضرورية لتشغيل الموقع وأخرى تحليلية لفهم استخدامك للموقع. بموافقتك، تساعدنا في تحسين تجربتك. لا نبيع بياناتك الشخصية ولا نشاركها مع أي طرف.',
    accept: 'موافق',
    reject: 'الأساسية فقط',
  },
};
