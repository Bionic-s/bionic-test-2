...
const pillars: Pillar[] = [
  {
    ...
    lines: [
      ...
      { name: 'البيانات والتحليلات والذكاء', desc: 'منصات بيانات مهيأة للذكاء الاصطناعي، لوحات معلومات تنفيذية، إدارة بيانات رئيسية، تحليلات متقدمة' },
    ],
  },
  {
    ...
    <section className="py-20 md:py-28 bg-bg-primary relative overflow-hidden" ref={ref} dir="rtl">
      ...
      <div className="container mx-auto px-4 lg:px-12" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        <div className="text-center mb-16">
          ...
          >
            ٧ خطوط أعمال. ٣ ركائز. تحول مؤسسي متكامل.
          </motion.p>
        </div>
