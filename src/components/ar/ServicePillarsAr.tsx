...
const pillars: Pillar[] = [
  {
    ...
    title: 'الذكاء',
    tagline: 'ذكاء اصطناعي · تحليلات متقدمة · منصات بيانات',
    lines: [
      { name: 'الذكاء الاصطناعي المؤسسي والأتمتة', desc: 'وكلاء ذكاء اصطناعي، مساعدون أذكياء، وأتمتة عمليات ذكية على نطاق المؤسسة' },
      { name: 'البيانات والتحليلات والذكاء', desc: 'منصات بيانات مهيأة للذكاء الاصطناعي، لوحات معلومات تنفيذية، إدارة بيانات رئيسية، وتحليلات متقدمة' },
    ],
  },
  {
    icon: <Cog className="w-7 h-7" />,
    title: 'الأتمتة',
    tagline: 'تطبيقات مؤسسية · تكامل · سير عمل ذكي',
    lines: [
      { name: 'تطبيقات الأعمال وتجربة العملاء', desc: 'إدارة علاقات العملاء، مركز اتصال، أتمتة التسويق، تجارة رقمية، وتجربة الموظف' },
      { name: 'التكامل والعمليات الذكية', desc: 'معمارية API-first، معمارية بالأحداث، وتنسيق سير العمل عبر الأنظمة' },
    ],
  },
  {
    icon: <Shield className="w-7 h-7" />,
    title: 'الثقة',
    tagline: 'أمن سيبراني · سيادة رقمية · مرونة مؤسسية',
    lines: [
      { name: 'الأمن السيبراني والمرونة السيبرانية', desc: 'مركز عمليات أمنية، SIEM، معمارية Zero Trust، إدارة الهوية، ومرونة ضد برامج الفدية' },
      { name: 'البنية التحتية السيادية والسحابة الهجينة', desc: 'تحديث مراكز البيانات، تحديث التخزين، بنية تحتية للذكاء الاصطناعي، وسحابة هجينة بمعمارية سيادية' },
    ],
  },
];
    ...
    <section className="py-20 md:py-28 bg-bg-primary relative overflow-hidden" ref={ref} dir="rtl">
      ...
      <div className="container mx-auto px-4 lg:px-12" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        <div className="text-center mb-16">
          ...
          >
            ٧ خطوط أعمال متكاملة. ٣ ركائز. تحول مؤسسي شامل.
          </motion.p>
        </div>
            ...
            <div className="flex items-center gap-4 flex-row-reverse">
              ...
              <div className="text-right">
                ...
                <p className="text-tiny text-text-muted">
                  ثلاثة مستويات تشغيل. على مدار الساعة. حيادية تقنية. عبر جميع خطوط الأعمال الستة.
                </p>
              </div>
            </div>
