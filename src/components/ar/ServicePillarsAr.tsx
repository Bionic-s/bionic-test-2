...
const pillars: Pillar[] = [
  {
    ...
    lines: [
      { name: 'الذكاء الاصطناعي المؤسسي والأتمتة', desc: 'وكلاء ذكاء اصطناعي ومساعدون أذكياء، أتمتة عمليات ذكية' },
      { name: 'البيانات والتحليلات والذكاء', desc: 'منصات بيانات جاهزة للذكاء الاصطناعي، لوحات معلومات تنفيذية، إدارة بيانات رئيسية، تحليلات متقدمة' },
    ],
  },
  {
    ...
    lines: [
      { name: 'تطبيقات الأعمال وتجربة العملاء', desc: 'إدارة علاقات العملاء، مركز اتصال، أتمتة تسويق، تجارة، تجربة موظف' },
      { name: 'التكامل والعمليات الذكية', desc: 'معمارية قائمة على واجهات برمجة التطبيقات، معمارية بالأحداث، تنسيق سير العمل' },
    ],
  },
  {
    ...
    lines: [
      { name: 'الأمن السيبراني والمرونة السيبرانية', desc: 'مركز عمليات أمنية، SIEM، Zero Trust، هوية، مرونة ضد برامج الفدية' },
      { name: 'البنية التحتية السيادية والسحابة الهجينة', desc: 'تحديث مراكز البيانات، تحديث التخزين، بنية تحتية للذكاء الاصطناعي، سحابة هجينة' },
    ],
  },
];
    ...
    <section className="py-20 md:py-28 bg-bg-primary relative overflow-hidden" ref={ref} dir="rtl">
      ...
      <div className="container mx-auto px-4 lg:px-12" style={{ fontFamily: "'Tajawal', sans-serif" }}>
        <div className="text-center mb-16">
          ...
          >
            ٧ خطوط أعمال. ٣ قيم أساسية. تحول مؤسسي واحد متكامل بالذكاء الاصطناعي.
          </motion.p>
        </div>
            ...
            <div className="flex items-center gap-4 flex-row-reverse">
              ...
              <div className="text-right">
                ...
                <p className="text-tiny text-text-muted">
                  ٣ مستويات. على مدار الساعة. حيادية تقنية. عبر جميع خطوط الأعمال الستة.
                </p>
              </div>
            </div>
