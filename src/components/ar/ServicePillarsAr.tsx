...
const pillars: Pillar[] = [
  {
    ...
    lines: [
      { name: 'الذكاء الاصطناعي المؤسسي والأتمتة', desc: 'الذكاء الوكيلي، المساعدون الأذكياء، أتمتة العمليات الذكية' },
      { name: 'البيانات والتحليلات والاستخبارات', desc: 'منصات بيانات جاهزة للذكاء الاصطناعي، لوحات معلومات تنفيذية، إدارة البيانات الرئيسية، تحليلات متقدمة' },
    ],
  },
  {
    ...
    lines: [
      ...
      { name: 'التكامل والعمليات الذكية', desc: 'معمارية API، البنى المدفوعة بالأحداث، تنسيق سير العمل' },
    ],
  },
  {
    ...
    lines: [
      { name: 'الأمن السيبراني والمرونة السيبرانية', desc: 'مركز العمليات الأمنية، SIEM، Zero Trust، الهوية، المرونة ضد الفدية' },
            ...
            <div className="flex items-center gap-4 flex-row-reverse">
              ...
              <div className="text-right">
                ...
                <p className="text-tiny text-text-muted">
                  3 مستويات. 24×7. متعدد المزودين. عبر جميع خطوط الأعمال الستة.
                </p>
              </div>
            </div>
