...
const capabilities: Capability[] = [
  {
    ...
    challenge: 'تشير أبحاث القطاع إلى أن المؤسسات تقضي عادةً ٤٠+ ساعة لكل تقديم عطاء يدوي — منصات المشتريات الرقمية تخفّض هذا بنسبة ٦٠–٨٠٪.',
  ...
  },
  {
    ...
    challenge: 'التقارير التنظيمية قد تستهلك حتى ٦٠٪ من قدرة فريق الامتثال — المؤسسات الرائدة تخفّض هذا بشكل ملموس عبر الأتمتة الذكية.',
    outcome: 'أتمتة ذكية + لوحات معلومات آنية — تحقق عادةً انخفاضًا بنسبة ٤٠–٦٠٪ في أعباء الامتثال اليدوية.',
    serviceLine: 'البيانات والتحليلات والذكاء',
  },
  {
    icon: <Cpu className="w-6 h-6" />,
    industry: 'النفط والغاز والقطاع الصناعي',
    challenge: 'تشير أبحاث القطاع إلى أن التوقف غير المخطط له يكلّف ٤+ مليون ريال لكل خط إنتاج سنويًا — برامج الصيانة التنبؤية تخفّض الانقطاعات بنسبة ٣٠–٥٠٪.',
    outcome: 'صيانة تنبؤية + تحليلات إنترنت الأشياء الصناعي — تحقق عادةً انخفاضًا بنسبة ٣٠–٥٠٪ في التوقف غير المخطط له.',
